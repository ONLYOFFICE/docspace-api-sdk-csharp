...
namespace Docspace.Model
{
    ...
    public partial class TenantRoomQuotaSettings : IValidatableObject
    {
        ...
        public TenantRoomQuotaSettings(bool enableQuota = default(bool), long defaultQuota = default(long), DateTime? lastRecalculateDate = default(DateTime?), DateTime lastModified = default(DateTime))
        {
