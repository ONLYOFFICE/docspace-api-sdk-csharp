...
namespace Docspace.Model
{
    ...
    public partial class GetReferenceDataDtoInteger : IValidatableObject
    {
        ...
        public GetReferenceDataDtoInteger(string fileKey = default(string), string instanceId = default(string), int sourceFileId = default(int), string path = default(string), string link = default(string))
        {
