...
namespace Docspace.Model
{
    ...
    public partial class SignupAccountRequestDto : IValidatableObject
    {
        ...
        public SignupAccountRequestDto(EmployeeType? employeeType = default(EmployeeType?), string firstName = default(string), string lastName = default(string), string email = default(string), string passwordHash = default(string), string key = default(string), string culture = default(string), string serializedProfile = default(string))
        {
