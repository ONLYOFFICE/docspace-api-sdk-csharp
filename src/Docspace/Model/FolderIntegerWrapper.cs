...
namespace Docspace.Model
{
    ...
    public partial class FolderIntegerWrapper : IValidatableObject
    {
        ...
        public FolderIntegerWrapper(FolderDtoInteger response = default(FolderDtoInteger), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
