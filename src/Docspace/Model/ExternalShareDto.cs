...
namespace Docspace.Model
{
    ...
    public partial class ExternalShareDto : IValidatableObject
    {
        ...
        public ExternalShareDto(Status? status = default(Status?), string id = default(string), string title = default(string), int tenantId = default(int), string entityId = default(string), string entryTitle = default(string), bool shared = default(bool), Guid linkId = default(Guid), bool isAuthenticated = default(bool))
        {
            this.Status = status;
            this.Id = id;
            this.Title = title;
