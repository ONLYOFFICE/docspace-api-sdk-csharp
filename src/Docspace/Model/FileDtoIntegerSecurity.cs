...
namespace Docspace.Model
{
    ...
    public partial class FileDtoIntegerSecurity : IValidatableObject
    {
        ...
        public FileDtoIntegerSecurity(bool read = default, bool comment = default, bool fillForms = default, bool review = default, bool create = default, bool createFrom = default, bool edit = default, bool delete = default, bool customFilter = default, bool editRoom = default, bool rename = default, bool readHistory = default, bool varLock = default, bool editHistory = default, bool copyTo = default, bool copy = default, bool moveTo = default, bool move = default, bool pin = default, bool mute = default, bool editAccess = default, bool duplicate = default, bool submitToFormGallery = default, bool download = default, bool convert = default, bool copySharedLink = default, bool readLinks = default, bool reconnect = default, bool createRoomFrom = default, bool copyLink = default, bool embed = default, bool changeOwner = default, bool indexExport = default, bool startFilling = default, bool fillingStatus = default, bool resetFilling = default, bool stopFilling = default, bool openForm = default)
        {
            this.Read = read;
