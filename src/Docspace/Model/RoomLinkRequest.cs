...
namespace Docspace.Model
{
    ...
    public partial class RoomLinkRequest : IValidatableObject
    {
        ...
        /// <param name="denyDownload">Specifies whether downloading a file from a link is disabled or not.</param>
        public RoomLinkRequest(Guid linkId = default(Guid), FileShare? access = default(FileShare?), ApiDateTime expirationDate = default(ApiDateTime), string title = default(string), LinkType? linkType = default(LinkType?), string password = default(string), bool denyDownload = default(bool))
        {
            this.LinkId = linkId;
            this.Access = access;
        ...
        */
        ...
        /// </summary>
        /// <value>Specifies whether downloading a file from a link is disabled or not</value>
        /*
