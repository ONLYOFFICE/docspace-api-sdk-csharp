...
namespace Docspace.Model
{
    ...
    public partial class UpdateRoomRequest : IValidatableObject
    {
        ...
        public UpdateRoomRequest(string title = default(string), long? quota = default(long?), bool? indexing = default(bool?), bool? denyDownload = default(bool?), RoomDataLifetimeDto lifetime = default(RoomDataLifetimeDto), WatermarkRequestDto watermark = default(WatermarkRequestDto), LogoRequest logo = default(LogoRequest), List<string> tags = default(List<string>), string color = default(string), string cover = default(string))
        {
            this.Title = title;
            this.Quota = quota;
