...
namespace Docspace.Model
{
    ...
    public partial class CdnStorageSettings : IValidatableObject
    {
        ...
        public CdnStorageSettings(string module = default(string), Dictionary<string, string> props = default(Dictionary<string, string>), DateTime lastModified = default(DateTime))
        {
            this.Module = module;
            this.Props = props;
