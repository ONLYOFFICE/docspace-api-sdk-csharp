...
namespace Docspace.Model
{
    ...
    public partial class WatermarkRequestDto : IValidatableObject
    {
        ...
        public WatermarkRequestDto(bool? enabled = default(bool?), WatermarkAdditions? additions = default(WatermarkAdditions?), string text = default(string), int rotate = default(int), int imageScale = default(int), string imageUrl = default(string), double imageHeight = default(double), double imageWidth = default(double))
        {
