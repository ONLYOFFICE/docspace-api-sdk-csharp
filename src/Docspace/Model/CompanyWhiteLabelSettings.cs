...
namespace Docspace.Model
{
    ...
    public partial class CompanyWhiteLabelSettings : IValidatableObject
    {
        ...
        public CompanyWhiteLabelSettings(string companyName = default(string), string site = default(string), string email = default(string), string address = default(string), string phone = default(string), bool isLicensor = default(bool), DateTime lastModified = default(DateTime))
        {
