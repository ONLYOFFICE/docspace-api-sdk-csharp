...
namespace Docspace.Model
{
    ...
    public partial class IPRestrictionsSettingsWrapper : IValidatableObject
    {
        ...
        public IPRestrictionsSettingsWrapper(IPRestrictionsSettings response = default(IPRestrictionsSettings), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
