...
namespace Docspace.Model
{
    ...
    public partial class UpdateMemberRequestDto : IValidatableObject
    {
        ...
        public UpdateMemberRequestDto(string userId = default(string), bool? disable = default(bool?), string email = default(string), bool? isUser = default(bool?), string firstName = default(string), string lastName = default(string), List<Guid> department = default(List<Guid>), string title = default(string), string location = default(string), SexEnum? sex = default(SexEnum?), ApiDateTime birthday = default(ApiDateTime), ApiDateTime worksfrom = default(ApiDateTime), string comment = default(string), List<Contact> contacts = default(List<Contact>), string files = default(string), bool? spam = default(bool?))
        {
            this.UserId = userId;
