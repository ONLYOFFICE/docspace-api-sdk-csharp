...
namespace Docspace.Model
{
    ...
    public partial class STRINGArrayWrapper : IValidatableObject
    {
        ...
        public STRINGArrayWrapper(List<string> response = default(List<string>), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
