...
namespace DocSpace.Model
{
    ...
    public partial class STRINGArrayWrapper : IValidatableObject
    {
        ...
        public STRINGArrayWrapper(List<string> response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
