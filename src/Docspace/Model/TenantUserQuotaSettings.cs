...
namespace Docspace.Model
{
    ...
    public partial class TenantUserQuotaSettings : IValidatableObject
    {
        ...
        public TenantUserQuotaSettings(bool enableQuota = default(bool), long defaultQuota = default(long), DateTime? lastRecalculateDate = default(DateTime?), DateTime lastModified = default(DateTime))
        {
