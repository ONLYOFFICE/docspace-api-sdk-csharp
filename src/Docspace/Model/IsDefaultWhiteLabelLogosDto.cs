...
namespace Docspace.Model
{
    ...
    public partial class IsDefaultWhiteLabelLogosDto : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="name">White label logo name.</param>
        /// <param name="varDefault">Specifies if the white label logo is default or not.</param>
        public IsDefaultWhiteLabelLogosDto(string name = default(string), bool varDefault = default(bool))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>White label logo name</value>
        /*
