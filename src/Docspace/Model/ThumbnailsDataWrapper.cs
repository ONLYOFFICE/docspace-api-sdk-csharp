...
namespace Docspace.Model
{
    ...
    public partial class ThumbnailsDataWrapper : IValidatableObject
    {
        ...
        public ThumbnailsDataWrapper(ThumbnailsDataDto response = default(ThumbnailsDataDto), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
