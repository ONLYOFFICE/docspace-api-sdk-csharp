...
namespace Docspace.Model
{
    ...
    public partial class EmailActivationSettingsWrapper : IValidatableObject
    {
        ...
        public EmailActivationSettingsWrapper(EmailActivationSettings response = default(EmailActivationSettings), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
