...
namespace DocSpace.Model
{
    ...
    public partial class EmailActivationSettingsWrapper : IValidatableObject
    {
        ...
        public EmailActivationSettingsWrapper(EmailActivationSettings response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
