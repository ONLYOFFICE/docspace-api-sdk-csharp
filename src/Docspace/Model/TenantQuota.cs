...
namespace Docspace.Model
{
    ...
    public partial class TenantQuota : IValidatableObject
    {
        ...
        /// <param name="priceCurrencySymbol">Price currency symbol.</param>
        /// <param name="productId">Product ID.</param>
        /// <param name="visible">Specifies if the tenant quota is visible or not.</param>
        /// <param name="features">Tenant quota features.</param>
        /// <param name="maxFileSize">Maximum file size.</param>
        /// <param name="maxTotalSize">Maximum total size.</param>
        /// <param name="countUser">Number of portal users.</param>
        /// <param name="countRoomAdmin">Number of portal room administrators.</param>
        /// <param name="usersInRoom">Number of room users.</param>
        /// <param name="countRoom">Number of rooms.</param>
        ...
        /// <param name="docsEdition">Specifies if this tenant quota is Docs edition or not.</param>
        ...
        /// <param name="statistic">Specifies if the statistic settings are available or not.</param>
        ...
        /// <param name="lifetime">Specifies if the license is lifetime or not.</param>
        /// <param name="custom">Specifies if the custom domain URL is available or not.</param>
        /// <param name="autoBackupRestore">Specifies if the automatic Backup&amp;Restore feature is available or not.</param>
        ...
        public TenantQuota(int tenantId = default(int), string name = default(string), double price = default(double), string priceCurrencySymbol = default(string), string productId = default(string), bool visible = default(bool), string features = default(string), long maxFileSize = default(long), long maxTotalSize = default(long), int countUser = default(int), int countRoomAdmin = default(int), int usersInRoom = default(int), int countRoom = default(int), bool nonProfit = default(bool), bool trial = default(bool), bool free = default(bool), bool update = default(bool), bool audit = default(bool), bool docsEdition = default(bool), bool ldap = default(bool), bool sso = default(bool), bool statistic = default(bool), bool branding = default(bool), bool customization = default(bool), bool lifetime = default(bool), bool custom = default(bool), bool autoBackupRestore = default(bool), bool oauth = default(bool), bool contentSearch = default(bool), bool thirdParty = default(bool), bool year = default(bool))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>Price currency symbol</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Tenant quota features</value>
        /*
        <example>some text</example>
        */
        ...
        */
        ...
        /// Maximum total size
        /// </summary>
        /// <value>Maximum total size</value>
        ...
        /// </summary>
        /// <value>Number of portal users</value>
        /*
        <example>1234</example>
        */
        ...
        /// </summary>
        /// <value>Number of portal room administrators</value>
        /*
        <example>1234</example>
        */
        ...
        /// </summary>
        /// <value>Number of room users</value>
        /*
        <example>1234</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>Specifies if this tenant quota is Docs edition or not</value>
        /*
        <example>true</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>Specifies if the statistic settings are available or not</value>
        /*
        <example>true</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>Specifies if the license is lifetime or not</value>
        /*
        <example>true</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>Specifies if the automatic Backup&amp;Restore feature is available or not</value>
        /*
        <example>true</example>
        */
