...
namespace Docspace.Model
{
    ...
    public partial class SmtpOperationStatusRequestsWrapper : IValidatableObject
    {
        ...
        public SmtpOperationStatusRequestsWrapper(SmtpOperationStatusRequestsDto response = default(SmtpOperationStatusRequestsDto), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
