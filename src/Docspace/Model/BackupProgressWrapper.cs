...
namespace Docspace.Model
{
    ...
    public partial class BackupProgressWrapper : IValidatableObject
    {
        ...
        public BackupProgressWrapper(BackupProgress response = default(BackupProgress), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
