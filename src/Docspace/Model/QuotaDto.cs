...
namespace Docspace.Model
{
    ...
    public partial class QuotaDto : IValidatableObject
    {
        ...
        public QuotaDto(int id = default(int), string title = default(string), PriceDto price = default(PriceDto), bool nonProfit = default(bool), bool free = default(bool), bool trial = default(bool), List<TenantQuotaFeatureDto> features = default(List<TenantQuotaFeatureDto>), TenantEntityQuotaSettings usersQuota = default(TenantEntityQuotaSettings), TenantEntityQuotaSettings roomsQuota = default(TenantEntityQuotaSettings), TenantQuotaSettings tenantCustomQuota = default(TenantQuotaSettings), DateTime? dueDate = default(DateTime?))
        {
            this.Id = id;
            this.Title = title;
            this.Price = price;
