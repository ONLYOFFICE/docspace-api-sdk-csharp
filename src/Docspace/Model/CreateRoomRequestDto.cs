...
namespace Docspace.Model
{
    ...
    public partial class CreateRoomRequestDto : IValidatableObject
    {
        ...
        /// <param name="denyDownload">Room quota.</param>
        ...
        public CreateRoomRequestDto(string title = default(string), long? quota = default(long?), bool? indexing = default(bool?), bool? denyDownload = default(bool?), RoomDataLifetimeDto lifetime = default(RoomDataLifetimeDto), WatermarkRequestDto watermark = default(WatermarkRequestDto), LogoRequest logo = default(LogoRequest), List<string> tags = default(List<string>), string color = default(string), string cover = default(string), RoomType? roomType = default(RoomType?), bool varPrivate = default(bool), List<FileShareParams> share = default(List<FileShareParams>))
        {
            this.Title = title;
            this.Quota = quota;
        ...
        */
        ...
        /// </summary>
        /// <value>Collection of sharing parameters</value>
