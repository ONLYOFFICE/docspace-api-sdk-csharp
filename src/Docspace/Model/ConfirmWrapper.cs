...
namespace Docspace.Model
{
    ...
    public partial class ConfirmWrapper : IValidatableObject
    {
        ...
        public ConfirmWrapper(ConfirmDto response = default(ConfirmDto), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
