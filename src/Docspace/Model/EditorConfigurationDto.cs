...
namespace Docspace.Model
{
    ...
    public partial class EditorConfigurationDto : IValidatableObject
    {
        ...
        /// <param name="createUrl">Create url.</param>
        /// <param name="customization">customization.</param>
        /// <param name="embedded">embedded.</param>
        /// <param name="encryptionKeys">encryptionKeys.</param>
        /// <param name="lang">Lang.</param>
        /// <param name="mode">Mode.</param>
        /// <param name="modeWrite">Mode write.</param>
        /// <param name="plugins">plugins.</param>
        /// <param name="recent">Recent.</param>
        /// <param name="templates">Templates.</param>
        /// <param name="user">user.</param>
        public EditorConfigurationDto(string callbackUrl = default(string), CoEditingConfig coEditing = default(CoEditingConfig), string createUrl = default(string), CustomizationConfigDto customization = default(CustomizationConfigDto), EmbeddedConfig embedded = default(EmbeddedConfig), EncryptionKeysConfig encryptionKeys = default(EncryptionKeysConfig), string lang = default(string), string mode = default(string), bool modeWrite = default(bool), PluginsConfig plugins = default(PluginsConfig), List<RecentConfig> recent = default(List<RecentConfig>), List<TemplatesConfig> templates = default(List<TemplatesConfig>), UserConfig user = default(UserConfig))
        {
