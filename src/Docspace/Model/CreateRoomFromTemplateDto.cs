...
namespace Docspace.Model
{
    ...
    public partial class CreateRoomFromTemplateDto : IValidatableObject
    {
        ...
        public CreateRoomFromTemplateDto(int templateId = default(int), string title = default(string), LogoRequest logo = default(LogoRequest), bool copyLogo = default(bool), List<string> tags = default(List<string>), string color = default(string), string cover = default(string), long? quota = default(long?))
        {
