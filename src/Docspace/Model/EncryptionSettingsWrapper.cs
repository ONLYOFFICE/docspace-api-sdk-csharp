...
namespace DocSpace.Model
{
    ...
    public partial class EncryptionSettingsWrapper : IValidatableObject
    {
        ...
        public EncryptionSettingsWrapper(EncryptionSettings response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
