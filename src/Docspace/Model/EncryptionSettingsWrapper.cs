...
namespace Docspace.Model
{
    ...
    public partial class EncryptionSettingsWrapper : IValidatableObject
    {
        ...
        public EncryptionSettingsWrapper(EncryptionSettings response = default(EncryptionSettings), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
