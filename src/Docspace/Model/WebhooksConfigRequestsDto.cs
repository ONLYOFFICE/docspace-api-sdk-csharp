...
namespace Docspace.Model
{
    ...
    public partial class WebhooksConfigRequestsDto : IValidatableObject
    {
        ...
        public WebhooksConfigRequestsDto(int id = default(int), string name = default(string), string uri = default(string), string secretKey = default(string), bool enabled = default(bool), bool ssl = default(bool), WebhookTrigger? triggers = default(WebhookTrigger?), string targetId = default(string))
        {
