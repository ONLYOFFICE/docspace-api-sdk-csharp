...
namespace Docspace.Model
{
    ...
    public partial class ApiKeyResponseArrayWrapper : IValidatableObject
    {
        ...
        public ApiKeyResponseArrayWrapper(List<ApiKeyResponseDto> response = default(List<ApiKeyResponseDto>), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
