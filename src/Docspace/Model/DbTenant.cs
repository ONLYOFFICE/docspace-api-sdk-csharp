...
namespace Docspace.Model
{
    ...
    public partial class DbTenant : IValidatableObject
    {
        ...
        /// <param name="versionChanged">Version_changed.</param>
        /// <param name="versionChanged">Version changed.</param>
        /// <param name="language">Language.</param>
        /// <param name="varTimeZone">Time zone.</param>
        /// <param name="trustedDomainsRaw">Trusted domains raw.</param>
        /// <param name="trustedDomainsEnabled">trustedDomainsEnabled.</param>
        /// <param name="status">status.</param>
        /// <param name="statusChanged">Status changed.</param>
        /// <param name="statusChangedHack">Status changed hack.</param>
        ...
        public DbTenant(int id = default(int), string name = default(string), string alias = default(string), string mappedDomain = default(string), int varVersion = default(int), DateTime? version_Changed = default(DateTime?), DateTime versionChanged = default(DateTime), string language = default(string), string varTimeZone = default(string), string trustedDomainsRaw = default(string), TenantTrustedDomainsType? trustedDomainsEnabled = default(TenantTrustedDomainsType?), TenantStatus? status = default(TenantStatus?), DateTime? statusChanged = default(DateTime?), DateTime statusChangedHack = default(DateTime), DateTime creationDateTime = default(DateTime), Guid? ownerId = default(Guid?), string paymentId = default(string), TenantIndustry? industry = default(TenantIndustry?), DateTime lastModified = default(DateTime), bool calls = default(bool), DbTenantPartner partner = default(DbTenantPartner))
        {
            this.Id = id;
            this.Name = name;
            this.Alias = alias;
        ...
        */
        ...
        /// Trusted domains raw
        /// </summary>
        /// <value>Trusted domains raw</value>
        /*
        <example>some text</example>
        */
        ...
        */
        ...
        /// Status changed hack
        /// </summary>
        /// <value>Status changed hack</value>
        /*
        <example>2008-04-10T06:30+04:00</example>
        */
