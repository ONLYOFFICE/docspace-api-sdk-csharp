...
namespace Docspace.Model
{
    ...
    public partial class UpdateWebhooksConfigRequestsDto : IValidatableObject
    {
        ...
        public UpdateWebhooksConfigRequestsDto(string name = default(string), string uri = default(string), string secretKey = default(string), bool enabled = default(bool), bool ssl = default(bool), WebhookTrigger? triggers = default(WebhookTrigger?), string targetId = default(string), int id = default(int))
        {
