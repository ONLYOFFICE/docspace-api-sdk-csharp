...
namespace DocSpace.Model
{
    ...
    public partial class PageableResponseClientInfoResponse : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">The paginated client data..</param>
        ...
        public PageableResponseClientInfoResponse(Object data = default, int limit = default, string lastClientId = default, DateTime lastCreatedOn = default)
        {
            this.Data = data;
            this.Limit = limit;
