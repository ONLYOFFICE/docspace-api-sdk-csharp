...
namespace Docspace.Model
{
    ...
    public partial class IPRestrictionArrayWrapper : IValidatableObject
    {
        ...
        public IPRestrictionArrayWrapper(List<IPRestriction> response = default(List<IPRestriction>), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
