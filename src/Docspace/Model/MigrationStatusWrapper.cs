...
namespace Docspace.Model
{
    ...
    public partial class MigrationStatusWrapper : IValidatableObject
    {
        ...
        public MigrationStatusWrapper(MigrationStatusDto response = default(MigrationStatusDto), int count = default(int), List<ActiveConnectionsWrapperLinksInner> links = default(List<ActiveConnectionsWrapperLinksInner>), int status = default(int), int statusCode = default(int))
        {
