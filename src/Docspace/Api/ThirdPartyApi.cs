...
namespace Docspace.Api
{
    ...
    public partial class ThirdPartyApi : IDisposable, IThirdPartyApi
    {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-third-party-code/">REST API Reference for GetThirdPartyCode Operation</seealso>
        /// <returns>Task of ApiResponse (ObjectWrapper)</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<ObjectWrapper>> GetThirdPartyCodeWithHttpInfoAsync(LoginProvider provider, System.Threading.CancellationToken cancellationToken = default)
        {
