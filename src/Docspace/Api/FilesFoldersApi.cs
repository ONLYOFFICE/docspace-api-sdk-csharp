...
namespace Docspace.Api
{
    ...
    public interface IFilesFoldersApiSync : IApiAccessor
    {
        ...
        /// <param name="checkUploadRequest">Parameters for checking files uploading (optional)</param>
        ...
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">Folder ID</param>
        /// <param name="createFolder">Folder (optional)</param>
        ...
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">Folder ID</param>
        /// <param name="deleteFolder">Parameters for deleting a folder (optional)</param>
        ...
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">Folder ID</param>
        /// <param name="userIdOrGroupId">User or group ID (optional)</param>
        /// <param name="filterType">Filter type (optional)</param>
        /// <param name="roomId">Room ID (optional)</param>
        ...
        /// <param name="extension">Specifies whether to search for a specific file extension (optional)</param>
        /// <param name="searchArea">Search area (optional)</param>
        /// <param name="formsItemKey"> (optional)</param>
        /// <param name="formsItemType"> (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">File ID</param>
        ...
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">Folder ID</param>
        /// <param name="insertFileFile">File (optional)</param>
        /// <param name="insertFileTitle">File name (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="file">File (optional)</param>
        /// <param name="title">File name (optional)</param>
        ...
        /// <param name="orderRequestDto">Order information for the folder (optional)</param>
        /// <returns></returns>
        void SetFileOrder(int folderId, OrderRequestDto? orderRequestDto = default(OrderRequestDto?));
        ...
        ApiResponse<Object> SetFileOrderWithHttpInfo(int folderId, OrderRequestDto? orderRequestDto = default(OrderRequestDto?));
        /// <summary>
        /// Upload a file
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">Folder ID</param>
        /// <param name="uploadRequestDto">Upload data (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inDto">Request parameters for uploading a file (optional)</param>
        /// <returns>ObjectWrapper</returns>
    ...
    public interface IFilesFoldersApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task SetFileOrderAsync(int folderId, OrderRequestDto? orderRequestDto = default(OrderRequestDto?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> SetFileOrderWithHttpInfoAsync(int folderId, OrderRequestDto? orderRequestDto = default(OrderRequestDto?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Upload a file
        /// </summary>
        /// <remarks>
    ...
    public partial class FilesFoldersApi : IDisposable, IFilesFoldersApi
    {
        ...
        /// <summary>
        /// Get folder form filter Get form filter of a folder with id specified in request
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">Folder ID</param>
        /// <returns>FormsItemArrayWrapper</returns>
        ...
        /// <summary>
        /// Get folder history Get the activity history of a folder with a specified identifier
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">File ID</param>
        /// <param name="fromDate">Start date (optional)</param>
        ...
        /// <summary>
        /// Sets file order in the folder with ID specified in the request Sets file order in the folder with ID specified in the request
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">The unique identifier of the folder</param>
        /// <param name="orderRequestDto">Order information for the folder (optional)</param>
        /// <returns></returns>
        public void SetFileOrder(int folderId, OrderRequestDto? orderRequestDto = default(OrderRequestDto?))
        {
            SetFileOrderWithHttpInfo(folderId, orderRequestDto);
        }
        ...
        /// <param name="orderRequestDto">Order information for the folder (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Docspace.Client.ApiResponse<Object> SetFileOrderWithHttpInfo(int folderId, OrderRequestDto? orderRequestDto = default(OrderRequestDto?))
        {
            Docspace.Client.RequestOptions localVarRequestOptions = new Docspace.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/api/2.0/files/folder/{folderId}/order", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task SetFileOrderAsync(int folderId, OrderRequestDto? orderRequestDto = default(OrderRequestDto?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            await SetFileOrderWithHttpInfoAsync(folderId, orderRequestDto, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<Object>> SetFileOrderWithHttpInfoAsync(int folderId, OrderRequestDto? orderRequestDto = default(OrderRequestDto?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/api/2.0/files/folder/{folderId}/order", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
