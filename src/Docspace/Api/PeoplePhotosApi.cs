...
namespace Docspace.Api
{
    ...
    public interface IPeoplePhotosApiSync : IApiAccessor
    {
        ...
        /// <param name="thumbnailsRequest">Thumbnails (optional)</param>
        ...
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userid">User ID</param>
        /// <param name="updatePhotoMemberRequest">Update photo (optional)</param>
        /// <returns>ThumbnailsDataWrapper</returns>
        ...
        FileUploadResultWrapper UploadMemberPhoto(string userid, List<KeyValuePairStringStringValues>? formCollection = default(List<KeyValuePairStringStringValues>?));
        ...
        ApiResponse<FileUploadResultWrapper> UploadMemberPhotoWithHttpInfo(string userid, List<KeyValuePairStringStringValues>? formCollection = default(List<KeyValuePairStringStringValues>?));
    ...
    public interface IPeoplePhotosApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FileUploadResultWrapper> UploadMemberPhotoAsync(string userid, List<KeyValuePairStringStringValues>? formCollection = default(List<KeyValuePairStringStringValues>?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<FileUploadResultWrapper>> UploadMemberPhotoWithHttpInfoAsync(string userid, List<KeyValuePairStringStringValues>? formCollection = default(List<KeyValuePairStringStringValues>?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class PeoplePhotosApi : IDisposable, IPeoplePhotosApi
    {
        ...
        /// <summary>
        /// Create photo thumbnails Creates photo thumbnails by coordinates of the original image specified in the request.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userid">User ID</param>
        /// <param name="thumbnailsRequest">Thumbnails (optional)</param>
        ...
        /// <param name="formCollection">Image data (optional)</param>
        /// <returns>FileUploadResultWrapper</returns>
        public FileUploadResultWrapper UploadMemberPhoto(string userid, List<KeyValuePairStringStringValues>? formCollection = default(List<KeyValuePairStringStringValues>?))
        {
        ...
        /// <param name="formCollection">Image data (optional)</param>
        /// <returns>ApiResponse of FileUploadResultWrapper</returns>
        public Docspace.Client.ApiResponse<FileUploadResultWrapper> UploadMemberPhotoWithHttpInfo(string userid, List<KeyValuePairStringStringValues>? formCollection = default(List<KeyValuePairStringStringValues>?))
        {
            // verify the required parameter 'userid' is set
            if (userid == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileUploadResultWrapper</returns>
        public async System.Threading.Tasks.Task<FileUploadResultWrapper> UploadMemberPhotoAsync(string userid, List<KeyValuePairStringStringValues>? formCollection = default(List<KeyValuePairStringStringValues>?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileUploadResultWrapper)</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<FileUploadResultWrapper>> UploadMemberPhotoWithHttpInfoAsync(string userid, List<KeyValuePairStringStringValues>? formCollection = default(List<KeyValuePairStringStringValues>?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'userid' is set
            if (userid == null)
                throw new Docspace.Client.ApiException(400, "Missing required parameter 'userid' when calling PeoplePhotosApi->UploadMemberPhoto");
