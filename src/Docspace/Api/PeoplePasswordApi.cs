...
namespace Docspace.Api
{
    ...
    public partial class PeoplePasswordApi : IDisposable, IPeoplePasswordApi
    {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/change-user-password/">REST API Reference for ChangeUserPassword Operation</seealso>
        /// <returns>ApiResponse of EmployeeFullWrapper</returns>
        public Docspace.Client.ApiResponse<EmployeeFullWrapper> ChangeUserPasswordWithHttpInfo(Guid userid, MemberBaseRequestDto? memberBaseRequestDto = default)
        {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/change-user-password/">REST API Reference for ChangeUserPassword Operation</seealso>
        /// <returns>Task of ApiResponse (EmployeeFullWrapper)</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<EmployeeFullWrapper>> ChangeUserPasswordWithHttpInfoAsync(Guid userid, MemberBaseRequestDto? memberBaseRequestDto = default, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/send-user-password/">REST API Reference for SendUserPassword Operation</seealso>
        /// <returns>ApiResponse of StringWrapper</returns>
        public Docspace.Client.ApiResponse<StringWrapper> SendUserPasswordWithHttpInfo(EmailMemberRequestDto? emailMemberRequestDto = default)
        {
            Docspace.Client.RequestOptions localVarRequestOptions = new Docspace.Client.RequestOptions();
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/send-user-password/">REST API Reference for SendUserPassword Operation</seealso>
        /// <returns>Task of ApiResponse (StringWrapper)</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<StringWrapper>> SendUserPasswordWithHttpInfoAsync(EmailMemberRequestDto? emailMemberRequestDto = default, System.Threading.CancellationToken cancellationToken = default)
        {
