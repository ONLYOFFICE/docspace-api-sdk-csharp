...
namespace DocSpace.Api
{
    ...
    public class PeopleGuestsApi : IDisposable, IPeopleGuestsApi
    {
        ...
        public ApiResponse<EmployeeFullWrapper> ApproveGuestShareLinkWithHttpInfo(EmailMemberRequestDto? emailMemberRequestDto = default)
        {
            ...
            {
                var exception = this.ExceptionFactory("ApproveGuestShareLink", localVarResponse);
        ...
        {
            ApiResponse<EmployeeFullWrapper> localVarResponse = await ApproveGuestShareLinkWithHttpInfoAsync(emailMemberRequestDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/approve-guest-share-link/">REST API Reference for ApproveGuestShareLink Operation</seealso>
        /// <returns>Task of ApiResponse (EmployeeFullWrapper)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EmployeeFullWrapper>> ApproveGuestShareLinkWithHttpInfoAsync(EmailMemberRequestDto? emailMemberRequestDto = default, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        public ApiResponse<Object> DeleteGuestsWithHttpInfo(UpdateMembersRequestDto? updateMembersRequestDto = default)
        {
            ...
            if (this.ExceptionFactory != null)
            {
                var exception = this.ExceptionFactory("DeleteGuests", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/delete-guests/">REST API Reference for DeleteGuests Operation</seealso>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteGuestsWithHttpInfoAsync(UpdateMembersRequestDto? updateMembersRequestDto = default, System.Threading.CancellationToken cancellationToken = default)
        {
