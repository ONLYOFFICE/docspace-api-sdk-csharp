...
namespace Docspace.Api
{
    ...
    public interface IPortalQuotaApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="refresh">Specifies whether the tariff will be refreshed (optional)</param>
    ...
    public partial class PortalQuotaApi : IDisposable, IPortalQuotaApi
    {
        ...
        /// <summary>
        /// Get the used portal space Returns the used space of the current portal.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>DoubleWrapper</returns>
