...
namespace Docspace.Api
{
    ...
    public partial class AuthorizationApi : IDisposable, IAuthorizationApi
    {
        ...
        /// <returns></returns>
        public AuthorizationApi(Docspace.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public AuthorizationApi(HttpClient client, Docspace.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public AuthorizationApi(Docspace.Client.ISynchronousClient client, Docspace.Client.IAsynchronousClient asyncClient, Docspace.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public Docspace.Client.ApiResponse<Object> Oauth2AuthorizeGetWithHttpInfo(string responseType, string clientId, string redirectUri, string scope)
        {
            ...
            if (responseType == null)
                throw new Docspace.Client.ApiException(400, "Missing required parameter 'responseType' when calling AuthorizationApi->Oauth2AuthorizeGet");

            // verify the required parameter 'clientId' is set
            if (clientId == null)
                throw new Docspace.Client.ApiException(400, "Missing required parameter 'clientId' when calling AuthorizationApi->Oauth2AuthorizeGet");

            // verify the required parameter 'redirectUri' is set
            if (redirectUri == null)
                throw new Docspace.Client.ApiException(400, "Missing required parameter 'redirectUri' when calling AuthorizationApi->Oauth2AuthorizeGet");

            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Docspace.Client.ApiException(400, "Missing required parameter 'scope' when calling AuthorizationApi->Oauth2AuthorizeGet");
        ...
        /// <summary>
        /// OAuth2 Consent Endpoint Sends consent approval
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="clientId"> (optional)</param>
        /// <param name="state"> (optional)</param>
