...
namespace Docspace.Api
{
    ...
    public interface IPeopleThirdPartyAccountsApiSync : IApiAccessor
    {
        ...
        /// <param name="settingsView">Specifies whether to return URLs in the format that is used on the Settings page (optional)</param>
        /// <param name="clientCallback">Method that is called after authorization (optional)</param>
        /// <param name="fromOnly">Provider name if the response only from this provider is needed (optional)</param>
