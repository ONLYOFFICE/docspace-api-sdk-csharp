...
namespace Docspace.Api
{
    ...
    public interface IFilesOperationsApiSync : IApiAccessor
    {
        ...
        /// <param name="start">Specifies if a conversion operation is started or not (optional)</param>
        ...
        /// <param name="sessionRequest">Session (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inDto">Request parameters for copying/moving files (optional)</param>
        ...
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="fileId">File ID</param>
        /// <param name="checkConversionRequestDtoInteger">Check conversion (optional)</param>
        /// <returns>ConversationResultArrayWrapper</returns>
        ...
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="fileId">File ID</param>
        /// <param name="updateComment">Parameters for updating a comment (optional)</param>
    ...
    public partial class FilesOperationsApi : IDisposable, IFilesOperationsApi
    {
        ...
        /// <summary>
        /// Copy to a folder Copies all the selected files and folders to the folder with the ID specified in the request.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="batchRequestDto"> (optional)</param>
        /// <returns>FileOperationArrayWrapper</returns>
        ...
        /// <summary>
        /// Chunked upload Creates a session to upload large files in multiple chunks to the folder with the ID specified in the request.   **Note**: Each chunk can have different length but the length should be multiple of &lt;b&gt;512&lt;/b&gt; and greater or equal to &lt;b&gt;10 mb&lt;/b&gt;. Last chunk can have any size.  After the initial response to the request with the &lt;b&gt;200 OK&lt;/b&gt; status, you must get the &lt;em&gt;location&lt;/em&gt; field value from the response. Send all your chunks to this location.  Each chunk must be sent in the exact order the chunks appear in the file.  After receiving each chunk, the server will respond with the current information about the upload session if no errors occurred.  When the number of bytes uploaded is equal to the number of bytes you sent in the initial request, the server responds with the &lt;b&gt;201 Created&lt;/b&gt; status and sends you information about the uploaded file.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="folderId">Folder ID</param>
        /// <param name="sessionRequest">Session (optional)</param>
        ...
        /// <summary>
        /// Duplicates all the selected files and folders Duplicates all the selected files and folders
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="duplicateRequestDto"> (optional)</param>
        /// <returns>FileOperationArrayWrapper</returns>
        ...
        /// <summary>
        /// Get active operations Returns a list of all the active operations.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>FileOperationArrayWrapper</returns>
        ...
        /// <summary>
        /// Retrieves the statuses of operations filtered by the specified operation type. Retrieves the statuses of operations filtered by the specified operation type.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationType">Specifies the type of file operation to be retrieved.</param>
        /// <returns>FileOperationArrayWrapper</returns>
        ...
        /// <summary>
        /// Move to a folder Moves all the selected files and folders to the folder with the ID specified in the request.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="batchRequestDto"> (optional)</param>
        /// <returns>FileOperationArrayWrapper</returns>
        ...
        /// <summary>
        /// Check files and folders for conflicts Checks a batch of files and folders for conflicts when moving or copying them to the folder with the ID specified in the request.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inDto">Request parameters for copying/moving files (optional)</param>
        /// <returns>FileEntryArrayWrapper</returns>
        ...
        /// <summary>
        /// Moves or copies Moves or copies
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inDto">Request parameters for copying/moving files (optional)</param>
        /// <returns>CheckDestFolderWrapper</returns>
