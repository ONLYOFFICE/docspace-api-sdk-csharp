...
namespace Docspace.Api
{
    ...
    public interface ISecurityAuditTrailDataApiSync : IApiAccessor
    {
        ...
        /// <param name="productType">Product (optional)</param>
        /// <param name="moduleType">Module (optional)</param>
        /// <param name="actionType">Action type (optional)</param>
        /// <param name="action">Action (optional)</param>
        /// <param name="entryType">Entry (optional)</param>
        /// <param name="target">Target (optional)</param>
    ...
    public partial class SecurityAuditTrailDataApi : IDisposable, ISecurityAuditTrailDataApi
    {
        ...
        /// <summary>
        /// Get audit trail data Returns a list of the latest changes (creation, modification, deletion, etc.) made by users to the entities (tasks, opportunities, files, etc.) on the portal.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>AuditEventArrayWrapper</returns>
