...
namespace Docspace.Api
{
    ...
    public partial class SettingsStatisticsApi : IDisposable, ISettingsStatisticsApi
    {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-space-usage-statistics/">REST API Reference for GetSpaceUsageStatistics Operation</seealso>
        /// <returns>Task of ApiResponse (UsageSpaceStatItemArrayWrapper)</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<UsageSpaceStatItemArrayWrapper>> GetSpaceUsageStatisticsWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default)
        {
