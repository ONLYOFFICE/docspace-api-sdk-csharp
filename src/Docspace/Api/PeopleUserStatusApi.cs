...
namespace Docspace.Api
{
    ...
    public interface IPeopleUserStatusApiSync : IApiAccessor
    {
        ...
        /// <param name="updateMembersRequestDto">Update members (optional)</param>
        /// <returns>EmployeeFullArrayWrapper</returns>
    ...
    public partial class PeopleUserStatusApi : IDisposable, IPeopleUserStatusApi
    {
        ...
        /// <summary>
        /// Get profiles by status Returns a list of profiles filtered by user status.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="status">User status</param>
        /// <returns>EmployeeFullArrayWrapper</returns>
        ...
        /// <summary>
        /// Change a user status Changes a status for the users with the IDs specified in the request.
        /// </summary>
        /// <exception cref="Docspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="status">New user status</param>
        /// <param name="updateMembersRequestDto">Update members (optional)</param>
