...
namespace Docspace.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class GroupRoomsApi : IDisposable, IGroupRoomsApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupRoomsApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public GroupRoomsApi(Docspace.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public GroupRoomsApi(HttpClient client, Docspace.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public GroupRoomsApi(Docspace.Client.ISynchronousClient client, Docspace.Client.IAsynchronousClient asyncClient, Docspace.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-groups-with-shared/">REST API Reference for GetGroupsWithShared Operation</seealso>
        /// <returns>ApiResponse of GroupArrayWrapper</returns>
        public Docspace.Client.ApiResponse<GroupArrayWrapper> GetGroupsWithSharedWithHttpInfo(int id, bool? excludeShared = default, int? count = default, int? startIndex = default, string? filterValue = default)
        {
            ...
            {
                Exception _exception = this.ExceptionFactory("GetGroupsWithShared", localVarResponse);
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-groups-with-shared/">REST API Reference for GetGroupsWithShared Operation</seealso>
        /// <returns>Task of ApiResponse (GroupArrayWrapper)</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<GroupArrayWrapper>> GetGroupsWithSharedWithHttpInfoAsync(int id, bool? excludeShared = default, int? count = default, int? startIndex = default, string? filterValue = default, System.Threading.CancellationToken cancellationToken = default)
        {
