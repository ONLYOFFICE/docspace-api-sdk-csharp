...
namespace Docspace.Api
{
    ...
    public class CapabilitiesApi : IDisposable, ICapabilitiesApi
    {
        ...
        public ApiResponse<CapabilitiesWrapper> GetPortalCapabilitiesWithHttpInfo()
        {
            ...
            {
                var exception = this.ExceptionFactory("GetPortalCapabilities", localVarResponse);
        ...
        {
            ApiResponse<CapabilitiesWrapper> localVarResponse = await GetPortalCapabilitiesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-portal-capabilities/">REST API Reference for GetPortalCapabilities Operation</seealso>
        /// <returns>Task of ApiResponse (CapabilitiesWrapper)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CapabilitiesWrapper>> GetPortalCapabilitiesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default)
        {
