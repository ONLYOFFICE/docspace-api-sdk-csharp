...
namespace Docspace.Api
{
    ...
    public partial class SettingsAuthorizationApi : IDisposable, ISettingsAuthorizationApi
    {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-auth-services/">REST API Reference for GetAuthServices Operation</seealso>
        /// <returns>Task of ApiResponse (AuthServiceRequestsArrayWrapper)</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<AuthServiceRequestsArrayWrapper>> GetAuthServicesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/save-auth-keys/">REST API Reference for SaveAuthKeys Operation</seealso>
        /// <returns>ApiResponse of BooleanWrapper</returns>
        public Docspace.Client.ApiResponse<BooleanWrapper> SaveAuthKeysWithHttpInfo(AuthServiceRequestsDto? authServiceRequestsDto = default)
        {
            Docspace.Client.RequestOptions localVarRequestOptions = new Docspace.Client.RequestOptions();
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/save-auth-keys/">REST API Reference for SaveAuthKeys Operation</seealso>
        /// <returns>Task of ApiResponse (BooleanWrapper)</returns>
        public async System.Threading.Tasks.Task<Docspace.Client.ApiResponse<BooleanWrapper>> SaveAuthKeysWithHttpInfoAsync(AuthServiceRequestsDto? authServiceRequestsDto = default, System.Threading.CancellationToken cancellationToken = default)
        {
