...
namespace Docspace.Test.Api
{
    ...
    public class PeopleSearchApiTests : IDisposable
    {
        ...
        public void GetAccountsEntriesWithSharedTest()
        {
            ...
            //var response = instance.GetAccountsEntriesWithShared(id, employeeStatus, activationStatus, excludeShared, invitedByMe, inviterId, area, employeeTypes);
        ...
        public void GetUsersWithRoomSharedTest()
        {
            ...
            //Area? area = null;
            //List<EmployeeType>? employeeTypes = null;
            //var response = instance.GetUsersWithRoomShared(id, employeeStatus, activationStatus, excludeShared, invitedByMe, inviterId, area, employeeTypes);
            //Assert.IsType<EmployeeFullArrayWrapper>(response);
        }
    }
}
