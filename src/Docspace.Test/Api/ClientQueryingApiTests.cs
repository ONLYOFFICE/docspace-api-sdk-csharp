...
{
    /// <summary>
    ///  Class for testing ClientQueryingApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class ClientQueryingApiTests : IDisposable
    {
        private ClientQueryingApi instance;

        public ClientQueryingApiTests()
        {
            instance = new ClientQueryingApi();
        }
        ...
        /// <summary>
        /// Test an instance of ClientQueryingApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' ClientQueryingApi
            //Assert.IsType<ClientQueryingApi>(instance);
        }
