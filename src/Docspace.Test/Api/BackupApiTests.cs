...
namespace Docspace.Test.Api
{
    ...
    public class BackupApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.DeleteBackupHistory();
            //Assert.IsType<BooleanWrapper>(response);
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.DeleteBackupSchedule();
            //Assert.IsType<BooleanWrapper>(response);
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetBackupHistory();
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetBackupProgress();
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetBackupSchedule();
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetRestoreProgress();
            //Assert.IsType<BackupProgressWrapper>(response);
        }
