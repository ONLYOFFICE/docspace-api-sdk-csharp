...
{
    /// <summary>
    ///  Class for testing FilesRoomsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class FilesRoomsApiTests : IDisposable
    {
        private FilesRoomsApi instance;

        public FilesRoomsApiTests()
        {
            instance = new FilesRoomsApi();
        }
        ...
        /// <summary>
        /// Test an instance of FilesRoomsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' FilesRoomsApi
            //Assert.IsType<FilesRoomsApi>(instance);
        }
