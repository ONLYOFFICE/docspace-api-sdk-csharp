...
namespace DocSpace.API.SDK.Test.Api
{
    ...
    public class RoomsApiTests : IDisposable
    {
        ...
        public void GetRoomTagsInfoTest()
        {
            ...
            //string? filterValue = null;
            //string fields = null;
            //var response = instance.GetRoomTagsInfo(count, startIndex, filterValue, fields);
        ...
        public void GetRoomsFolderTest()
        {
            ...
            //string? filterValue = null;
            //string fields = null;
            //var response = instance.GetRoomsFolder(type, subjectId, searchArea, withoutTags, tags, excludeSubject, provider, subjectFilter, quotaFilter, storageFilter, count, startIndex, sortBy, sortOrder, filterValue, fields);
