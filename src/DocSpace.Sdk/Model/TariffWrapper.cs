...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class TariffWrapper : IValidatableObject
    {
        ...
        public TariffWrapper(Tariff response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
