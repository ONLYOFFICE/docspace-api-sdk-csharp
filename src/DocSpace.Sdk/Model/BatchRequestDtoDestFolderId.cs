...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class BatchRequestDtoDestFolderId : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        {
            return JsonSerializer.Serialize(this.ActualInstance, BatchRequestDtoDestFolderId.SerializerOptions);
        }
        ...
        public static BatchRequestDtoDestFolderId FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                newBatchRequestDtoDestFolderId = new BatchRequestDtoDestFolderId(JsonSerializer.Deserialize<int>(jsonString, BatchRequestDtoDestFolderId.SerializerOptions));
            ...
            try
            {
                // System.Text.Json doesn't have a direct equivalent to AdditionalProperties handling
                // We'll use the default options for all types
                newBatchRequestDtoDestFolderId = new BatchRequestDtoDestFolderId(JsonSerializer.Deserialize<string>(jsonString, BatchRequestDtoDestFolderId.SerializerOptions));
    ...
    /// </summary>
    public class BatchRequestDtoDestFolderIdJsonConverter : JsonConverter<BatchRequestDtoDestFolderId>
    {
        /// <summary>
        ...
        public override void Write(Utf8JsonWriter writer, BatchRequestDtoDestFolderId value, JsonSerializerOptions options)
        {
        ...
        public override BatchRequestDtoDestFolderId Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            using (JsonDocument document = JsonDocument.ParseValue(ref reader))
            {
                ...
                switch (root.ValueKind)
                {
                    case JsonValueKind.Number when root.TryGetInt32(out int intValue):
                        return new BatchRequestDtoDestFolderId(intValue);
                    case JsonValueKind.String:
                        return new BatchRequestDtoDestFolderId(root.GetString());
                    case JsonValueKind.Object:
                    case JsonValueKind.Array:
                        return BatchRequestDtoDestFolderId.FromJson(root.GetRawText());
                    default:
