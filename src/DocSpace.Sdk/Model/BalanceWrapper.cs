...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class BalanceWrapper : IValidatableObject
    {
        ...
        public BalanceWrapper(Balance response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
