...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class FolderIntegerWrapper : IValidatableObject
    {
        ...
        public FolderIntegerWrapper(FolderDtoInteger response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
