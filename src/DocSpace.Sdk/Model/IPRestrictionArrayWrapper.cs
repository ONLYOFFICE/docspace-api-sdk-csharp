...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class IPRestrictionArrayWrapper : IValidatableObject
    {
        ...
        public IPRestrictionArrayWrapper(List<IPRestriction> response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
