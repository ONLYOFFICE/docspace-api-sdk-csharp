...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class MigrationStatusWrapper : IValidatableObject
    {
        ...
        public MigrationStatusWrapper(MigrationStatusDto response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
