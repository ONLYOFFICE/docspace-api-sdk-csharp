...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class SmtpOperationStatusRequestsWrapper : IValidatableObject
    {
        ...
        public SmtpOperationStatusRequestsWrapper(SmtpOperationStatusRequestsDto response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
