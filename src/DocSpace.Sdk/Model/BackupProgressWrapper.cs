...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class BackupProgressWrapper : IValidatableObject
    {
        ...
        public BackupProgressWrapper(BackupProgress response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
