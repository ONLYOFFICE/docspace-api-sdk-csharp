...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class DocumentBuilderTaskWrapper : IValidatableObject
    {
        ...
        public DocumentBuilderTaskWrapper(DocumentBuilderTaskDto response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
