...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class ReportWrapper : IValidatableObject
    {
        ...
        public ReportWrapper(Report response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
