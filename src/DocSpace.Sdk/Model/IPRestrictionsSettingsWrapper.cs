...
namespace DocSpace.Sdk.Model
{
    ...
    public partial class IPRestrictionsSettingsWrapper : IValidatableObject
    {
        ...
        public IPRestrictionsSettingsWrapper(IPRestrictionsSettings response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
