...
namespace DocSpace.Sdk.Api
{
    ...
    public interface IFilesFilesApiAsync : IApiAccessor
    {
        ...
        Task<FileEntryWrapper> CopyFileAsAsync(int fileId, CopyAsJsonElement? copyAsJsonElement = default, CancellationToken cancellationToken = default);
        ...
        Task<ApiResponse<FileEntryWrapper>> CopyFileAsWithHttpInfoAsync(int fileId, CopyAsJsonElement? copyAsJsonElement = default, CancellationToken cancellationToken = default);
        /// <summary>
        /// Create the editing session
        /// </summary>
        /// <remarks>
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/set-files-order/">REST API Reference for SetFilesOrder Operation</seealso>
        /// <returns>Task of FileIntegerArrayWrapper</returns>
        Task<FileIntegerArrayWrapper> SetFilesOrderAsync(OrdersRequestDtoInteger? ordersRequestDtoInteger = default, CancellationToken cancellationToken = default);
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/set-files-order/">REST API Reference for SetFilesOrder Operation</seealso>
        /// <returns>Task of ApiResponse (FileIntegerArrayWrapper)</returns>
        Task<ApiResponse<FileIntegerArrayWrapper>> SetFilesOrderWithHttpInfoAsync(OrdersRequestDtoInteger? ordersRequestDtoInteger = default, CancellationToken cancellationToken = default);
        /// <summary>
        /// Start file editing
        /// </summary>
        /// <remarks>
    ...
    public class FilesFilesApi : IDisposable, IFilesFilesApi
    {
        ...
        public ApiResponse<FileEntryWrapper> CopyFileAsWithHttpInfo(int fileId, CopyAsJsonElement? copyAsJsonElement = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = Client.Post<FileEntryWrapper>("/api/2.0/files/file/{fileId}/copyas", localVarRequestOptions, Configuration);
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/copy-file-as/">REST API Reference for CopyFileAs Operation</seealso>
        /// <returns>Task of FileEntryWrapper</returns>
        public async Task<FileEntryWrapper> CopyFileAsAsync(int fileId, CopyAsJsonElement? copyAsJsonElement = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/copy-file-as/">REST API Reference for CopyFileAs Operation</seealso>
        /// <returns>Task of ApiResponse (FileEntryWrapper)</returns>
        public async Task<ApiResponse<FileEntryWrapper>> CopyFileAsWithHttpInfoAsync(int fileId, CopyAsJsonElement? copyAsJsonElement = default, CancellationToken cancellationToken = default)
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<FileEntryWrapper>("/api/2.0/files/file/{fileId}/copyas", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public async Task<ApiResponse<FileIntegerWrapper>> SaveEditingFileFromFormWithHttpInfoAsync(int fileId, string? fileExtension = default, string? downloadUri = default, FileParameter? file = default, bool? forcesave = default, CancellationToken cancellationToken = default)
        {
            ...
            if (fileExtension != null)
            {
                localVarRequestOptions.FormParameters.Add("FileExtension", DocSpace.Sdk.Client.ClientUtils.ParameterToString(fileExtension)); // form parameter
            }
            if (downloadUri != null)
            {
                localVarRequestOptions.FormParameters.Add("DownloadUri", DocSpace.Sdk.Client.ClientUtils.ParameterToString(downloadUri)); // form parameter
            }
            if (file != null)
            {
                localVarRequestOptions.FileParameters.Add("File", file);
            ...
            if (forcesave != null)
            {
                localVarRequestOptions.FormParameters.Add("Forcesave", DocSpace.Sdk.Client.ClientUtils.ParameterToString(forcesave)); // form parameter
            }
        ...
        public ApiResponse<FileIntegerArrayWrapper> SetFilesOrderWithHttpInfo(OrdersRequestDtoInteger? ordersRequestDtoInteger = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = Client.Put<FileIntegerArrayWrapper>("/api/2.0/files/order", localVarRequestOptions, Configuration);
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/set-files-order/">REST API Reference for SetFilesOrder Operation</seealso>
        /// <returns>Task of FileIntegerArrayWrapper</returns>
        public async Task<FileIntegerArrayWrapper> SetFilesOrderAsync(OrdersRequestDtoInteger? ordersRequestDtoInteger = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/set-files-order/">REST API Reference for SetFilesOrder Operation</seealso>
        /// <returns>Task of ApiResponse (FileIntegerArrayWrapper)</returns>
        public async Task<ApiResponse<FileIntegerArrayWrapper>> SetFilesOrderWithHttpInfoAsync(OrdersRequestDtoInteger? ordersRequestDtoInteger = default, CancellationToken cancellationToken = default)
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            var localVarResponse = await AsynchronousClient.PutAsync<FileIntegerArrayWrapper>("/api/2.0/files/order", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
