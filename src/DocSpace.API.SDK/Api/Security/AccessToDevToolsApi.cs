...
namespace DocSpace.API.SDK.Api.Security
{
    ...
    public class AccessToDevToolsApi : IDisposable, IAccessToDevToolsApi
    {
        ...
        public ApiResponse<TenantDevToolsAccessSettingsWrapper> SetTenantDevToolsAccessSettingsWithHttpInfo(TenantDevToolsAccessSettingsDto? tenantDevToolsAccessSettingsDto = default)
        {
            ...
            var localVarResponse = Client.Post<TenantDevToolsAccessSettingsWrapper>("/api/2.0/settings/devtoolsaccess", localVarRequestOptions, Configuration);

            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("SetTenantDevToolsAccessSettings", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        public async Task<ApiResponse<TenantDevToolsAccessSettingsWrapper>> SetTenantDevToolsAccessSettingsWithHttpInfoAsync(TenantDevToolsAccessSettingsDto? tenantDevToolsAccessSettingsDto = default, CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<TenantDevToolsAccessSettingsWrapper>("/api/2.0/settings/devtoolsaccess", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
