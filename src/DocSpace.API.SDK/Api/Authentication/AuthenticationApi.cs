...
namespace DocSpace.API.SDK.Api.Authentication
{
    ...
    public interface IAuthenticationApiAsync : IApiAccessor
    {
        ...
        Task<BooleanWrapper> GetIsAuthentificatedAsync(CancellationToken cancellationToken = default);
        ...
        Task<ApiResponse<BooleanWrapper>> GetIsAuthentificatedWithHttpInfoAsync(CancellationToken cancellationToken = default);
        /// <summary>
        /// Log out
        /// </summary>
        /// <remarks>
        ...
        Task<StringWrapper> LogoutAsync(CancellationToken cancellationToken = default);
        ...
        Task<ApiResponse<StringWrapper>> LogoutWithHttpInfoAsync(CancellationToken cancellationToken = default);
        /// <summary>
        /// Set a mobile phone
        /// </summary>
        /// <remarks>
    ...
    public class AuthenticationApi : IDisposable, IAuthenticationApi
    {
        ...
        public ApiResponse<AuthenticationTokenWrapper> AuthenticateMeWithHttpInfo(AuthRequestsDto? authRequestsDto = default)
        {
            ...
            {
                var exception = ExceptionFactory("AuthenticateMe", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        public async Task<ApiResponse<AuthenticationTokenWrapper>> AuthenticateMeWithHttpInfoAsync(AuthRequestsDto? authRequestsDto = default, CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<AuthenticationTokenWrapper>("/api/2.0/authentication", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<AuthenticationTokenWrapper> AuthenticateMeFromBodyWithCodeWithHttpInfo(string code, AuthRequestsDto? authRequestsDto = default)
        {
            ...
            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("AuthenticateMeFromBodyWithCode", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        public async Task<ApiResponse<AuthenticationTokenWrapper>> AuthenticateMeFromBodyWithCodeWithHttpInfoAsync(string code, AuthRequestsDto? authRequestsDto = default, CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<AuthenticationTokenWrapper>("/api/2.0/authentication/{code}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<ConfirmWrapper> CheckConfirmWithHttpInfo(EmailValidationKeyModel? emailValidationKeyModel = default)
        {
            ...
            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("CheckConfirm", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        public async Task<ApiResponse<ConfirmWrapper>> CheckConfirmWithHttpInfoAsync(EmailValidationKeyModel? emailValidationKeyModel = default, CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<ConfirmWrapper>("/api/2.0/authentication/confirm", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<BooleanWrapper> GetIsAuthentificatedWithHttpInfo()
        {
            ...
            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("GetIsAuthentificated", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-is-authentificated/">REST API Reference for GetIsAuthentificated Operation</seealso>
        /// <returns>Task of BooleanWrapper</returns>
        public async Task<BooleanWrapper> GetIsAuthentificatedAsync(CancellationToken cancellationToken = default)
        {
            var localVarResponse = await GetIsAuthentificatedWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-is-authentificated/">REST API Reference for GetIsAuthentificated Operation</seealso>
        /// <returns>Task of ApiResponse (BooleanWrapper)</returns>
        public async Task<ApiResponse<BooleanWrapper>> GetIsAuthentificatedWithHttpInfoAsync(CancellationToken cancellationToken = default)
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<BooleanWrapper>("/api/2.0/authentication", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<StringWrapper> LogoutWithHttpInfo()
        {
            ...
            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("Logout", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/logout/">REST API Reference for Logout Operation</seealso>
        /// <returns>Task of StringWrapper</returns>
        public async Task<StringWrapper> LogoutAsync(CancellationToken cancellationToken = default)
        {
            var localVarResponse = await LogoutWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/logout/">REST API Reference for Logout Operation</seealso>
        /// <returns>Task of ApiResponse (StringWrapper)</returns>
        public async Task<ApiResponse<StringWrapper>> LogoutWithHttpInfoAsync(CancellationToken cancellationToken = default)
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<StringWrapper>("/api/2.0/authentication/logout", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<AuthenticationTokenWrapper> SaveMobilePhoneWithHttpInfo(MobileRequestsDto? mobileRequestsDto = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = Client.Post<AuthenticationTokenWrapper>("/api/2.0/authentication/setphone", localVarRequestOptions, Configuration);

            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("SaveMobilePhone", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        public async Task<ApiResponse<AuthenticationTokenWrapper>> SaveMobilePhoneWithHttpInfoAsync(MobileRequestsDto? mobileRequestsDto = default, CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<AuthenticationTokenWrapper>("/api/2.0/authentication/setphone", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<AuthenticationTokenWrapper> SendSmsCodeWithHttpInfo(AuthRequestsDto? authRequestsDto = default)
        {
            ...
            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("SendSmsCode", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        public async Task<ApiResponse<AuthenticationTokenWrapper>> SendSmsCodeWithHttpInfoAsync(AuthRequestsDto? authRequestsDto = default, CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<AuthenticationTokenWrapper>("/api/2.0/authentication/sendsms", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
