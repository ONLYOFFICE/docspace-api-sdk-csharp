...
namespace DocSpace.API.SDK.Api.OAuth20
{
    ...
    /// </summary>
    public interface IClientManagementApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IClientManagementApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IClientManagementApi : IClientManagementApiSync, IClientManagementApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class ClientManagementApi : IDisposable, IClientManagementApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ClientManagementApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public ClientManagementApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientManagementApi"/> class using a Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public ClientManagementApi(Configuration configuration)
        {
        ...
        /// </remarks>
        public ClientManagementApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ClientManagementApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ClientManagementApi(HttpClient client, Configuration configuration, HttpClientHandler handler = null)
        {
            ArgumentNullException.ThrowIfNull(configuration);
            ArgumentNullException.ThrowIfNull(client);
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ClientManagementApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
            ArgumentNullException.ThrowIfNull(client);
        ...
        public ApiResponse<Object> ChangeActivationWithHttpInfo(string clientId, ChangeClientActivationRequest changeClientActivationRequest)
        {
            ...
            if (clientId == null)
                throw new ApiException(400, "Missing required parameter 'clientId' when calling ClientManagementApi->ChangeActivation");

            // verify the required parameter 'changeClientActivationRequest' is set
            if (changeClientActivationRequest == null)
                throw new ApiException(400, "Missing required parameter 'changeClientActivationRequest' when calling ClientManagementApi->ChangeActivation");
        ...
        public ApiResponse<ClientResponse> CreateClientWithHttpInfo(CreateClientRequest createClientRequest)
        {
            ...
            if (createClientRequest == null)
                throw new ApiException(400, "Missing required parameter 'createClientRequest' when calling ClientManagementApi->CreateClient");
        ...
        public ApiResponse<Object> DeleteClientWithHttpInfo(string clientId)
        {
            // verify the required parameter 'clientId' is set
            if (clientId == null)
                throw new ApiException(400, "Missing required parameter 'clientId' when calling ClientManagementApi->DeleteClient");
        ...
        public ApiResponse<Object> DeleteTenantClientsWithHttpInfo()
        {
            ...
            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("DeleteTenantClients", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        public ApiResponse<Object> DeleteUserClientsWithHttpInfo()
        {
            ...
            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("DeleteUserClients", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        public ApiResponse<ClientSecretResponse> RegenerateSecretWithHttpInfo(string clientId)
        {
            // verify the required parameter 'clientId' is set
            if (clientId == null)
                throw new ApiException(400, "Missing required parameter 'clientId' when calling ClientManagementApi->RegenerateSecret");
        ...
        public ApiResponse<Object> RevokeUserClientWithHttpInfo(string clientId)
        {
            // verify the required parameter 'clientId' is set
            if (clientId == null)
                throw new ApiException(400, "Missing required parameter 'clientId' when calling ClientManagementApi->RevokeUserClient");
        ...
        public ApiResponse<Object> UpdateClientWithHttpInfo(string clientId, UpdateClientRequest updateClientRequest)
        {
            // verify the required parameter 'clientId' is set
            if (clientId == null)
                throw new ApiException(400, "Missing required parameter 'clientId' when calling ClientManagementApi->UpdateClient");

            // verify the required parameter 'updateClientRequest' is set
            if (updateClientRequest == null)
                throw new ApiException(400, "Missing required parameter 'updateClientRequest' when calling ClientManagementApi->UpdateClient");
