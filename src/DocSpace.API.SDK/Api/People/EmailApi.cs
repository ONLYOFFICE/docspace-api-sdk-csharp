...
namespace DocSpace.API.SDK.Api.People
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class EmailApi : IDisposable, IEmailApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailApi"/> class using a Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public EmailApi(HttpClient client, Configuration configuration, HttpClientHandler handler = null)
        {
            ArgumentNullException.ThrowIfNull(configuration);
            ArgumentNullException.ThrowIfNull(client);
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public EmailApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
            ArgumentNullException.ThrowIfNull(client);
        ...
        public ApiResponse<EmployeeFullWrapper> ChangeUserEmailWithHttpInfo(Guid userid, ChangeEmailRequest changeEmailRequest)
        {
            ...
            if (changeEmailRequest == null)
                throw new ApiException(400, "Missing required parameter 'changeEmailRequest' when calling EmailApi->ChangeUserEmail");
            ...
            {
                var exception = ExceptionFactory("ChangeUserEmail", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
