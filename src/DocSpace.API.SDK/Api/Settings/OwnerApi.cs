...
namespace DocSpace.API.SDK.Api.Settings
{
    ...
    /// </summary>
    public interface IOwnerApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IOwnerApiAsync : IApiAccessor
    {
        ...
        Task<ApiResponse<Object>> UpdatePortalOwnerWithHttpInfoAsync(OwnerIdSettingsRequestDto? ownerIdSettingsRequestDto = default, CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IOwnerApi : IOwnerApiSync, IOwnerApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class OwnerApi : IDisposable, IOwnerApi
    {
        private ExceptionFactory _exceptionFactory = (_, _) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="OwnerApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public OwnerApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public OwnerApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OwnerApi"/> class using a Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public OwnerApi(Configuration configuration)
        {
        ...
        /// </remarks>
        public OwnerApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public OwnerApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public OwnerApi(HttpClient client, Configuration configuration, HttpClientHandler handler = null)
        {
            ArgumentNullException.ThrowIfNull(configuration);
            ArgumentNullException.ThrowIfNull(client);
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public OwnerApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
            ArgumentNullException.ThrowIfNull(client);
        ...
        public ApiResponse<OwnerChangeInstructionsWrapper> SendOwnerChangeInstructionsWithHttpInfo(OwnerIdSettingsRequestDto? ownerIdSettingsRequestDto = default)
        {
            ...
            var localVarResponse = Client.Post<OwnerChangeInstructionsWrapper>("/api/2.0/settings/owner", localVarRequestOptions, Configuration);

            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("SendOwnerChangeInstructions", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/send-owner-change-instructions/">REST API Reference for SendOwnerChangeInstructions Operation</seealso>
        /// <returns>Task of OwnerChangeInstructionsWrapper</returns>
        public async Task<OwnerChangeInstructionsWrapper> SendOwnerChangeInstructionsAsync(OwnerIdSettingsRequestDto? ownerIdSettingsRequestDto = default, CancellationToken cancellationToken = default)
        {
            var localVarResponse = await SendOwnerChangeInstructionsWithHttpInfoAsync(ownerIdSettingsRequestDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/send-owner-change-instructions/">REST API Reference for SendOwnerChangeInstructions Operation</seealso>
        /// <returns>Task of ApiResponse (OwnerChangeInstructionsWrapper)</returns>
        public async Task<ApiResponse<OwnerChangeInstructionsWrapper>> SendOwnerChangeInstructionsWithHttpInfoAsync(OwnerIdSettingsRequestDto? ownerIdSettingsRequestDto = default, CancellationToken cancellationToken = default)
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<OwnerChangeInstructionsWrapper>("/api/2.0/settings/owner", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<Object> UpdatePortalOwnerWithHttpInfo(OwnerIdSettingsRequestDto? ownerIdSettingsRequestDto = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = Client.Put<Object>("/api/2.0/settings/owner", localVarRequestOptions, Configuration);

            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("UpdatePortalOwner", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/update-portal-owner/">REST API Reference for UpdatePortalOwner Operation</seealso>
        /// <returns>Task of void</returns>
        public async Task UpdatePortalOwnerAsync(OwnerIdSettingsRequestDto? ownerIdSettingsRequestDto = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/update-portal-owner/">REST API Reference for UpdatePortalOwner Operation</seealso>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<Object>> UpdatePortalOwnerWithHttpInfoAsync(OwnerIdSettingsRequestDto? ownerIdSettingsRequestDto = default, CancellationToken cancellationToken = default)
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            var localVarResponse = await AsynchronousClient.PutAsync<Object>("/api/2.0/settings/owner", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
