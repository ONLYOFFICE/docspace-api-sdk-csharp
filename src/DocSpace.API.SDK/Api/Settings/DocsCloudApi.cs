...
namespace DocSpace.API.SDK.Api.Settings
{
    ...
    public interface IDocsCloudApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="DocSpace.API.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/check-health/">REST API Reference for CheckHealth Operation</seealso>
        /// <returns></returns>
        void CheckHealth();
    ...
    public interface IDocsCloudApiAsync : IApiAccessor
    {
        ...
        Task<ApiResponse<Object>> CheckHealthWithHttpInfoAsync(CancellationToken cancellationToken = default);
        /// <summary>
        /// Start the DocsCloud tenant quota report generation
        /// </summary>
        /// <remarks>
    ...
    public class DocsCloudApi : IDisposable, IDocsCloudApi
    {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/check-health/">REST API Reference for CheckHealth Operation</seealso>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> CheckHealthWithHttpInfo()
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<Object>("/api/2.0/settings/docscloud/healthcheck", localVarRequestOptions, Configuration);

            if (ExceptionFactory != null)
            {
                var exception = ExceptionFactory("CheckHealth", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        {
            await CheckHealthWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/check-health/">REST API Reference for CheckHealth Operation</seealso>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<Object>> CheckHealthWithHttpInfoAsync(CancellationToken cancellationToken = default)
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<Object>("/api/2.0/settings/docscloud/healthcheck", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
