...
namespace DocSpace.API.SDK.Api.Settings
{
    ...
    public interface IEncryptionApiSync : IApiAccessor
    {
        ...
        ApiResponse<UnknownWrapper> GetStorageEncryptionProgressWithHttpInfo();
        /// <summary>
    ...
    public interface IEncryptionApiAsync : IApiAccessor
    {
        ...
        Task<UnknownWrapper> GetStorageEncryptionProgressAsync(CancellationToken cancellationToken = default);
        ...
        Task<ApiResponse<UnknownWrapper>> GetStorageEncryptionProgressWithHttpInfoAsync(CancellationToken cancellationToken = default);
        /// <summary>
        /// Get the storage encryption settings
        /// </summary>
        /// <remarks>
    ...
    public class EncryptionApi : IDisposable, IEncryptionApi
    {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-storage-encryption-progress/">REST API Reference for GetStorageEncryptionProgress Operation</seealso>
        /// <returns>UnknownWrapper</returns>
        public UnknownWrapper GetStorageEncryptionProgress()
        {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-storage-encryption-progress/">REST API Reference for GetStorageEncryptionProgress Operation</seealso>
        /// <returns>ApiResponse of UnknownWrapper</returns>
        public ApiResponse<UnknownWrapper> GetStorageEncryptionProgressWithHttpInfo()
        {
            ...
            var localVarResponse = Client.Get<UnknownWrapper>("/api/2.0/settings/encryption/progress", localVarRequestOptions, Configuration);
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-storage-encryption-progress/">REST API Reference for GetStorageEncryptionProgress Operation</seealso>
        /// <returns>Task of UnknownWrapper</returns>
        public async Task<UnknownWrapper> GetStorageEncryptionProgressAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <seealso href="https://api.onlyoffice.com/docspace/api-backend/usage-api/get-storage-encryption-progress/">REST API Reference for GetStorageEncryptionProgress Operation</seealso>
        /// <returns>Task of ApiResponse (UnknownWrapper)</returns>
        public async Task<ApiResponse<UnknownWrapper>> GetStorageEncryptionProgressWithHttpInfoAsync(CancellationToken cancellationToken = default)
        {
            var localVarRequestOptions = new RequestOptions();
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<UnknownWrapper>("/api/2.0/settings/encryption/progress", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
