...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateRoomsRoomIdsRequestDto")]
    public partial class UpdateRoomsRoomIdsRequestDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRoomsRoomIdsRequestDto" /> class.
        /// </summary>
        ...
        public UpdateRoomsRoomIdsRequestDto(List<DuplicateRequestDtoAllOfFileIds> roomIds = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateRoomsRoomIdsRequestDto {\n");
