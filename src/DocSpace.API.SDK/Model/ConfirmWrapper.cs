...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class ConfirmWrapper : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">The ConfirmDto object returned by the operation..</param>
        ...
        public ConfirmWrapper(ConfirmDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
