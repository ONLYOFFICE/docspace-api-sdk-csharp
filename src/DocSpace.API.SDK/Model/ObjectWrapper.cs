...
namespace DocSpace.API.SDK.Model
{
    ...
    /// ObjectWrapper
    /// </summary>
    [DataContract(Name = "ObjectWrapper")]
    public partial class ObjectWrapper : IValidatableObject
    {
        ...
        public ObjectWrapper(Object response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
