...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiNewItemsAgentNewItemsArrayWrapper")]
    public partial class NewAiNewItemsAgentNewItemsArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiNewItemsAgentNewItemsArrayWrapper" /> class.
        /// </summary>
        ...
        public NewAiNewItemsAgentNewItemsArrayWrapper(List<NewAiNewItemsDtoAgentNewItemsDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<NewAiNewItemsDtoAgentNewItemsDto> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiNewItemsAgentNewItemsArrayWrapper {\n");
