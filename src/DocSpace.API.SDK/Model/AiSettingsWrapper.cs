...
namespace DocSpace.API.SDK.Model
{
    ...
    /// AiSettingsWrapper
    /// </summary>
    [DataContract(Name = "AiSettingsWrapper")]
    public partial class AiSettingsWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiSettingsWrapper" /> class.
        /// </summary>
        ...
        public AiSettingsWrapper(AiSettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public AiSettingsDto Response { get; set; }
