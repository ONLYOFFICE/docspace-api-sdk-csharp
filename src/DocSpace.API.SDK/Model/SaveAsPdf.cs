...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SaveAsPdf")]
    public partial class SaveAsPdf : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveAsPdf" /> class.
        /// </summary>
        ...
        public SaveAsPdf(int folderId = default, string title = default)
        {
            this.FolderId = folderId;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for SaveAsPdf and cannot be null");
            }
            this.Title = title;
        }
