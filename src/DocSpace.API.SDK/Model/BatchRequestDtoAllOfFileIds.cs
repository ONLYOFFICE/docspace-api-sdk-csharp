...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(BatchRequestDtoAllOfFileIdsJsonConverter))]
    [DataContract(Name = "BatchRequestDto_allOf_fileIds")]
    public partial class BatchRequestDtoAllOfFileIds : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchRequestDtoAllOfFileIds" /> class
        /// with the <see cref="int" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of int.</param>
        public BatchRequestDtoAllOfFileIds(int actualInstance)
        {
            IsNullable = false;
            SchemaType= "anyOf";
        ...
        public BatchRequestDtoAllOfFileIds(string actualInstance)
        {
            IsNullable = false;
            SchemaType= "anyOf";
        ...
        /// <summary>
        /// Converts the JSON string into an instance of BatchRequestDtoAllOfFileIds
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of BatchRequestDtoAllOfFileIds</returns>
        public static BatchRequestDtoAllOfFileIds FromJson(string jsonString)
        {
            BatchRequestDtoAllOfFileIds newBatchRequestDtoAllOfFileIds = null;
