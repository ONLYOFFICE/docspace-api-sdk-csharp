...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class BaseBatchRequestDtoAllOfFolderIds : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        {
            return JsonConvert.SerializeObject(ActualInstance, BaseBatchRequestDtoAllOfFolderIds.SerializerSettings);
        }
        ...
        public static BaseBatchRequestDtoAllOfFolderIds FromJson(string jsonString)
        {
            ...
            try
            {
                newBaseBatchRequestDtoAllOfFolderIds = new BaseBatchRequestDtoAllOfFolderIds(JsonConvert.DeserializeObject<int>(jsonString, BaseBatchRequestDtoAllOfFolderIds.SerializerSettings));
            ...
            try
            {
                newBaseBatchRequestDtoAllOfFolderIds = new BaseBatchRequestDtoAllOfFolderIds(JsonConvert.DeserializeObject<string>(jsonString, BaseBatchRequestDtoAllOfFolderIds.SerializerSettings));
                // deserialization is considered successful at this point if no exception has been thrown.
                return newBaseBatchRequestDtoAllOfFolderIds;
            }
            catch (Exception exception)
    ...
    /// </summary>
    public class BaseBatchRequestDtoAllOfFolderIdsJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(BaseBatchRequestDtoAllOfFolderIds).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.Integer: 
                    return new BaseBatchRequestDtoAllOfFolderIds(Convert.ToInt32(reader.Value));
                case JsonToken.String: 
                    return new BaseBatchRequestDtoAllOfFolderIds(Convert.ToString(reader.Value));
                case JsonToken.StartObject:
                    return BaseBatchRequestDtoAllOfFolderIds.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return BaseBatchRequestDtoAllOfFolderIds.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
