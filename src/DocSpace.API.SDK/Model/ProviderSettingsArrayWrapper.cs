...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProviderSettingsArrayWrapper")]
    public partial class ProviderSettingsArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ProviderSettingsArrayWrapper" /> class.
        /// </summary>
        ...
        public ProviderSettingsArrayWrapper(List<ProviderSettingsDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<ProviderSettingsDto> Response { get; set; }
