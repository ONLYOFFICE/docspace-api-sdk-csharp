...
namespace DocSpace.API.SDK.Model
{
    ...
    /// ObjectArrayWrapper
    /// </summary>
    [DataContract(Name = "ObjectArrayWrapper")]
    public partial class ObjectArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectArrayWrapper" /> class.
        /// </summary>
        ...
        public ObjectArrayWrapper(List<Object> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
