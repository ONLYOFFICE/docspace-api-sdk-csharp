...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiFileEntryBaseDto")]
    public partial class NewAiFileEntryBaseDto : IValidatableObject
    {
        ...
        public NewAiFileShare? Access { get; set; }

        /// <summary>
        /// Gets or Sets RootFolderType
        /// </summary>
        [DataMember(Name = "rootFolderType", EmitDefaultValue = false)]
        public NewAiFolderType? RootFolderType { get; set; }

        /// <summary>
        /// Gets or Sets ParentRoomType
        /// </summary>
        [DataMember(Name = "parentRoomType", EmitDefaultValue = false)]
        public NewAiFolderType? ParentRoomType { get; set; }

        /// <summary>
        /// Gets or Sets FileEntryType
        /// </summary>
        [DataMember(Name = "fileEntryType", EmitDefaultValue = false)]
        public NewAiFileEntryType? FileEntryType { get; set; }
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFileEntryBaseDto" /> class.
        /// </summary>
        ...
        public NewAiFileEntryBaseDto(string title = default, NewAiFileShare? access = default, NewAiEmployeeDto sharedBy = default, NewAiEmployeeDto ownedBy = default, bool shared = default, bool sharedForUser = default, bool sharedExternal = default, bool parentShared = default, string shortWebUrl = default, NewAiApiDateTime created = default, NewAiEmployeeDto createdBy = default, NewAiApiDateTime updated = default, NewAiApiDateTime autoDelete = default, NewAiFolderType? rootFolderType = default, NewAiFolderType? parentRoomType = default, NewAiEmployeeDto updatedBy = default, bool? providerItem = default, string providerKey = default, int? providerId = default, string order = default, bool? isFavorite = default, NewAiFileEntryType? fileEntryType = default)
        {
            this.Title = title;
            this.Access = access;
        ...
        */
        ...
        public NewAiEmployeeDto SharedBy { get; set; }

        /// <summary>
        /// Gets or Sets OwnedBy
        /// </summary>
        [DataMember(Name = "ownedBy", EmitDefaultValue = false)]
        public NewAiEmployeeDto OwnedBy { get; set; }
        ...
        */
        ...
        public NewAiApiDateTime Created { get; set; }

        /// <summary>
        /// Gets or Sets CreatedBy
        /// </summary>
        [DataMember(Name = "createdBy", EmitDefaultValue = false)]
        public NewAiEmployeeDto CreatedBy { get; set; }

        /// <summary>
        /// Gets or Sets Updated
        /// </summary>
        [DataMember(Name = "updated", EmitDefaultValue = false)]
        public NewAiApiDateTime Updated { get; set; }

        /// <summary>
        /// Gets or Sets AutoDelete
        /// </summary>
        [DataMember(Name = "autoDelete", EmitDefaultValue = false)]
        public NewAiApiDateTime AutoDelete { get; set; }

        /// <summary>
        /// Gets or Sets UpdatedBy
        /// </summary>
        [DataMember(Name = "updatedBy", EmitDefaultValue = false)]
        public NewAiEmployeeDto UpdatedBy { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiFileEntryBaseDto {\n");
