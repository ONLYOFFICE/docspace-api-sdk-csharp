...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class AiEntryPricingDtoAiEmbeddingPriceDto : IValidatableObject
    {
        ...
        protected AiEntryPricingDtoAiEmbeddingPriceDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiEntryPricingDtoAiEmbeddingPriceDto" /> class.
        /// </summary>
        ...
        public AiEntryPricingDtoAiEmbeddingPriceDto(string id = default, string alias = default, string provider = default, string image = default, AiEmbeddingPriceDto price = default, string link = default)
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AiEntryPricingDtoAiEmbeddingPriceDto and cannot be null");
            }
            this.Id = id;
            // to ensure "alias" is required (not null)
            if (alias == null)
            {
                throw new ArgumentNullException("alias is a required property for AiEntryPricingDtoAiEmbeddingPriceDto and cannot be null");
            }
            this.Alias = alias;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for AiEntryPricingDtoAiEmbeddingPriceDto and cannot be null");
            }
            this.Provider = provider;
            // to ensure "image" is required (not null)
            if (image == null)
            {
                throw new ArgumentNullException("image is a required property for AiEntryPricingDtoAiEmbeddingPriceDto and cannot be null");
            }
            this.Image = image;
            // to ensure "price" is required (not null)
            if (price == null)
            {
                throw new ArgumentNullException("price is a required property for AiEntryPricingDtoAiEmbeddingPriceDto and cannot be null");
            }
            this.Price = price;
            // to ensure "link" is required (not null)
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for AiEntryPricingDtoAiEmbeddingPriceDto and cannot be null");
            }
            this.Link = link;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AiEntryPricingDtoAiEmbeddingPriceDto {\n");
