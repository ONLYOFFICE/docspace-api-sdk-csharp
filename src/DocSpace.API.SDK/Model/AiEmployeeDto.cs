...
namespace DocSpace.API.SDK.Model
{
    ...
    /// The user parameters.
    /// </summary>
    [DataContract(Name = "AiEmployeeDto")]
    public partial class AiEmployeeDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiEmployeeDto" /> class.
        /// </summary>
        ...
        public AiEmployeeDto(Guid id = default, string displayName = default, string avatar = default, string avatarOriginal = default, string avatarMax = default, string avatarMedium = default, string avatarSmall = default, string profileUrl = default, bool hasAvatar = default, bool isAnonim = default)
        {
            this.Id = id;
