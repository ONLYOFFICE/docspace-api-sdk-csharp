...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiFileOperationWrapper")]
    public partial class NewAiFileOperationWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFileOperationWrapper" /> class.
        /// </summary>
        ...
        public NewAiFileOperationWrapper(NewAiFileOperationDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public NewAiFileOperationDto Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiFileOperationWrapper {\n");
