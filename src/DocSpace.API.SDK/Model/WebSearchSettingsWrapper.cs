...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebSearchSettingsWrapper")]
    public partial class WebSearchSettingsWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="WebSearchSettingsWrapper" /> class.
        /// </summary>
        ...
        public WebSearchSettingsWrapper(WebSearchSettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public WebSearchSettingsDto Response { get; set; }
