...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GeneratedFileWrapper")]
    public partial class GeneratedFileWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneratedFileWrapper" /> class.
        /// </summary>
        ...
        public GeneratedFileWrapper(GeneratedFileDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public GeneratedFileDto Response { get; set; }
