...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FolderDtoInteger_availableShareRights")]
    public partial class FolderDtoIntegerAvailableShareRights : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderDtoIntegerAvailableShareRights" /> class.
        /// </summary>
        ...
        public FolderDtoIntegerAvailableShareRights(List<string> user = default, List<string> externalLink = default, List<string> group = default, List<string> invitationLink = default, List<string> primaryExternalLink = default)
        {
            this.User = user;
