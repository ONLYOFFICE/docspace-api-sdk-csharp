...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FolderContentDtoString")]
    public partial class FolderContentDtoString : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderContentDtoString" /> class.
        /// </summary>
        ...
        public FolderContentDtoString(List<FileEntryBaseDto> files = default, List<FileEntryBaseDto> folders = default, FolderDtoString current = default, Object pathParts = default, int startIndex = default, int count = default, int total = default, int @new = default)
        {
            this.Files = files;
        ...
        public FolderDtoString Current { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FolderContentDtoString {\n");
