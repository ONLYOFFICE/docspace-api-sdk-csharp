...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class CustomerServiceUsageReportRequestDto : IValidatableObject
    {
        ...
        public CustomerServiceUsageReportRequestDto(string serviceName = default, DateTime? startDate = default, DateTime? endDate = default, string participantName = default, OperationStatus? status = default, Dictionary<string, string> metadata = default, string orderBy = default, OperationOrderType? orderType = default)
        {
