...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiEntryPricingDtoAiChatPriceDto")]
    public partial class AiEntryPricingDtoAiChatPriceDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiEntryPricingDtoAiChatPriceDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiEntryPricingDtoAiChatPriceDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiEntryPricingDtoAiChatPriceDto" /> class.
        /// </summary>
        ...
        public AiEntryPricingDtoAiChatPriceDto(string id = default, string alias = default, string provider = default, string image = default, AiChatPriceDto price = default, string link = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AiEntryPricingDtoAiChatPriceDto and cannot be null");
            }
            this.Id = id;
            // to ensure "alias" is required (not null)
            if (alias == null)
            {
                throw new ArgumentNullException("alias is a required property for AiEntryPricingDtoAiChatPriceDto and cannot be null");
            }
            this.Alias = alias;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for AiEntryPricingDtoAiChatPriceDto and cannot be null");
            }
            this.Provider = provider;
            // to ensure "image" is required (not null)
            if (image == null)
            {
                throw new ArgumentNullException("image is a required property for AiEntryPricingDtoAiChatPriceDto and cannot be null");
            }
            this.Image = image;
            // to ensure "price" is required (not null)
            if (price == null)
            {
                throw new ArgumentNullException("price is a required property for AiEntryPricingDtoAiChatPriceDto and cannot be null");
            }
            this.Price = price;
            // to ensure "link" is required (not null)
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for AiEntryPricingDtoAiChatPriceDto and cannot be null");
            }
            this.Link = link;
        }
        ...
        public AiChatPriceDto Price { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AiEntryPricingDtoAiChatPriceDto {\n");
