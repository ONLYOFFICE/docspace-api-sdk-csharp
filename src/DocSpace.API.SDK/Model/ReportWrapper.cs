...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReportWrapper")]
    public partial class ReportWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportWrapper" /> class.
        /// </summary>
        /// <param name="response">The ReportDto object returned by the operation..</param>
        ...
        public ReportWrapper(ReportDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public ReportDto Response { get; set; }
