...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiPromptBundle")]
    public partial class AiPromptBundle : IValidatableObject
    {
        ...
        public AiPromptBundle(VersionEnum version = default, List<AiPromptFolder> folders = default, List<AiPrompt> prompts = default)
        {
            ...
            if (folders == null)
            {
                throw new ArgumentNullException("folders is a required property for AiPromptBundle and cannot be null");
            }
            this.Folders = folders;
            // to ensure "prompts" is required (not null)
            if (prompts == null)
            {
                throw new ArgumentNullException("prompts is a required property for AiPromptBundle and cannot be null");
            }
