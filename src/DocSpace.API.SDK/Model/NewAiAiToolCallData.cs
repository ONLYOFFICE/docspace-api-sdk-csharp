...
namespace DocSpace.API.SDK.Model
{
    ...
    /// NewAiAiToolCallData
    /// </summary>
    [DataContract(Name = "NewAiAiToolCallData")]
    public partial class NewAiAiToolCallData : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiToolCallData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiAiToolCallData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiToolCallData" /> class.
        /// </summary>
        ...
        public NewAiAiToolCallData(string threadId = default, string messageId = default, decimal idx = default, NewAiThreadMessageLike message = default, NewAiAiActionArgs actionArgs = default, string entityId = default, string profileId = default)
        {
            // to ensure "threadId" is required (not null)
            if (threadId == null)
            {
                throw new ArgumentNullException("threadId is a required property for NewAiAiToolCallData and cannot be null");
            }
            this.ThreadId = threadId;
            // to ensure "messageId" is required (not null)
            if (messageId == null)
            {
                throw new ArgumentNullException("messageId is a required property for NewAiAiToolCallData and cannot be null");
            }
            ...
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for NewAiAiToolCallData and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiAiToolCallData {\n");
