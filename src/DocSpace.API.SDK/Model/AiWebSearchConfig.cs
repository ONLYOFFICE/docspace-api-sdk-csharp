...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiWebSearchConfig")]
    public partial class AiWebSearchConfig : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiWebSearchConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiWebSearchConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiWebSearchConfig" /> class.
        /// </summary>
        ...
        public AiWebSearchConfig(string provider = default, string key = default, string baseUrl = default, bool isCloudProvider = default, Dictionary<string, string> headers = default)
        {
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for AiWebSearchConfig and cannot be null");
            }
