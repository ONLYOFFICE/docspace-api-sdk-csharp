...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class Int32Wrapper : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">The int32 value returned by the operation..</param>
        ...
        public Int32Wrapper(int response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
