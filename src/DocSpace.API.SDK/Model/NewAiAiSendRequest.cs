...
namespace DocSpace.API.SDK.Model
{
    ...
    /// NewAiAiSendRequest
    /// </summary>
    [DataContract(Name = "newAiAiSend_request")]
    public partial class NewAiAiSendRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiSendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiAiSendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiSendRequest" /> class.
        /// </summary>
        ...
        public NewAiAiSendRequest(NewAiActionType actionType = default, NewAiThreadMessageLike userMessage = default, NewAiAiActionArgs actionArgs = default, string entityId = default)
        {
            this.ActionType = actionType;
            // to ensure "userMessage" is required (not null)
            if (userMessage == null)
            {
                throw new ArgumentNullException("userMessage is a required property for NewAiAiSendRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiAiSendRequest {\n");
