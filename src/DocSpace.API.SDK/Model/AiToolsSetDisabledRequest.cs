...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class AiToolsSetDisabledRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AiToolsSetDisabledRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiToolsSetDisabledRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiToolsSetDisabledRequest" /> class.
        /// </summary>
        ...
        public AiToolsSetDisabledRequest(string serverType = default, List<string> toolNames = default, string entityId = default)
        {
            // to ensure "serverType" is required (not null)
            if (serverType == null)
            {
                throw new ArgumentNullException("serverType is a required property for AiToolsSetDisabledRequest and cannot be null");
            }
            this.ServerType = serverType;
            // to ensure "toolNames" is required (not null)
            if (toolNames == null)
            {
                throw new ArgumentNullException("toolNames is a required property for AiToolsSetDisabledRequest and cannot be null");
            }
