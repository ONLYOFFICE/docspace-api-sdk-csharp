...
namespace DocSpace.API.SDK.Model
{
    ...
    /// The user parameters.
    /// </summary>
    [DataContract(Name = "NewAiEmployeeDto")]
    public partial class NewAiEmployeeDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiEmployeeDto" /> class.
        /// </summary>
        ...
        public NewAiEmployeeDto(Guid id = default, string displayName = default, string avatar = default, string avatarOriginal = default, string avatarMax = default, string avatarMedium = default, string avatarSmall = default, string profileUrl = default, bool hasAvatar = default, bool isAnonim = default)
        {
            this.Id = id;
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiEmployeeDto {\n");
