...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class DocumentConfigDto : IValidatableObject
    {
        ...
        /// <param name="permissions">The permissions configuration parameters..</param>
        ...
        /// <param name="referenceData">An object that is generated by the integrator to uniquely identify a file in its system..</param>
