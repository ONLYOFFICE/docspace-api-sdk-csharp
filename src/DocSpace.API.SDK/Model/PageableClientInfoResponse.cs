...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageableClientInfoResponse")]
    public partial class PageableClientInfoResponse : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageableClientInfoResponse" /> class.
        /// </summary>
        ...
        public PageableClientInfoResponse(List<ClientInfoResponse> data = default, int limit = default, string lastClientId = default, DateTime lastCreatedOn = default)
        {
            this.Data = data;
            this.Limit = limit;
        ...
        public List<ClientInfoResponse> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PageableClientInfoResponse {\n");
