...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiThread")]
    public partial class NewAiThread : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiThread" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiThread() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiThread" /> class.
        /// </summary>
        ...
        public NewAiThread(string threadId = default, string title = default, decimal lastEditDate = default, NewAiTProvider provider = default, NewAiModel model = default, string profileId = default)
        {
            // to ensure "threadId" is required (not null)
            if (threadId == null)
            {
                throw new ArgumentNullException("threadId is a required property for NewAiThread and cannot be null");
            }
        ...
        public NewAiTProvider Provider { get; set; }

        /// <summary>
        /// Gets or Sets Model
        /// </summary>
        [DataMember(Name = "model", EmitDefaultValue = false)]
        public NewAiModel Model { get; set; }
