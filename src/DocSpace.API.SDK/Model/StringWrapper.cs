...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringWrapper")]
    public partial class StringWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="StringWrapper" /> class.
        /// </summary>
        /// <param name="response">The string value returned by the operation..</param>
        ...
        public StringWrapper(string response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
