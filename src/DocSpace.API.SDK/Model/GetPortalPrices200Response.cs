...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPortalPrices_200_response")]
    public partial class GetPortalPrices200Response : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPortalPrices200Response" /> class.
        /// </summary>
        ...
        public GetPortalPrices200Response(Dictionary<string, double> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public Dictionary<string, double> Response { get; set; }
