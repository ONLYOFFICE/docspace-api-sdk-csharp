...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KeyValuePairBooleanStringWrapper")]
    public partial class KeyValuePairBooleanStringWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyValuePairBooleanStringWrapper" /> class.
        /// </summary>
        ...
        public KeyValuePairBooleanStringWrapper(KeyValuePairBooleanString response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public KeyValuePairBooleanString Response { get; set; }
