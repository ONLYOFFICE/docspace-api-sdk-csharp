...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiVectorizationSettingsWrapper")]
    public partial class NewAiVectorizationSettingsWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiVectorizationSettingsWrapper" /> class.
        /// </summary>
        ...
        public NewAiVectorizationSettingsWrapper(NewAiVectorizationSettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public NewAiVectorizationSettingsDto Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiVectorizationSettingsWrapper {\n");
