...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiProviderArrayWrapper")]
    public partial class AiProviderArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiProviderArrayWrapper" /> class.
        /// </summary>
        ...
        public AiProviderArrayWrapper(List<AiProviderDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<AiProviderDto> Response { get; set; }
