...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserInfoWrapper")]
    public partial class UserInfoWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="UserInfoWrapper" /> class.
        /// </summary>
        /// <param name="response">The UserInfo object returned by the operation..</param>
        ...
        public UserInfoWrapper(UserInfo response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
