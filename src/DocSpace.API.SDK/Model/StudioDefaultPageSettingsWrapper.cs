...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class StudioDefaultPageSettingsWrapper : IValidatableObject
    {
        ...
        public StudioDefaultPageSettingsWrapper(StudioDefaultPageSettings response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
