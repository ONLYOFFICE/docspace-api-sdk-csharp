...
namespace DocSpace.API.SDK.Model
{
    ...
    /// McpToolArrayWrapper
    /// </summary>
    [DataContract(Name = "McpToolArrayWrapper")]
    public partial class McpToolArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="McpToolArrayWrapper" /> class.
        /// </summary>
        ...
        public McpToolArrayWrapper(List<McpToolDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<McpToolDto> Response { get; set; }
