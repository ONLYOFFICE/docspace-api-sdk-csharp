...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WalletServiceWrapper")]
    public partial class WalletServiceWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletServiceWrapper" /> class.
        /// </summary>
        /// <param name="response">The WalletServiceDto object returned by the operation..</param>
        ...
        public WalletServiceWrapper(WalletServiceDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public WalletServiceDto Response { get; set; }
