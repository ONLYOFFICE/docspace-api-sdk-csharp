...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiAgentNewItemsDto")]
    public partial class AiAgentNewItemsDto : IValidatableObject
    {
        ...
        public AiAgentNewItemsDto(AiFileEntryBaseDto agent = default, List<AiFileEntryBaseDto> items = default)
        {
            ...
            if (agent == null)
            {
                throw new ArgumentNullException("agent is a required property for AiAgentNewItemsDto and cannot be null");
            }
            this.Agent = agent;
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for AiAgentNewItemsDto and cannot be null");
            }
            this.Items = items;
        }
        ...
        public List<AiFileEntryBaseDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AiAgentNewItemsDto {\n");
