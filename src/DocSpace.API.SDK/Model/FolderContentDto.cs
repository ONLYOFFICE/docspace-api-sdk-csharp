...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FolderContentDto")]
    public partial class FolderContentDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderContentDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolderContentDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderContentDto" /> class.
        /// </summary>
        ...
        public FolderContentDto(List<FileEntryBaseDto> files = default, List<FileEntryBaseDto> folders = default, FolderDto current = default, Object pathParts = default, int startIndex = default, int count = default, int total = default, int @new = default)
        {
            // to ensure "pathParts" is required (not null)
            if (pathParts == null)
            {
                throw new ArgumentNullException("pathParts is a required property for FolderContentDto and cannot be null");
            }
        ...
        public FolderDto Current { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FolderContentDto {\n");
