...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CspWrapper")]
    public partial class CspWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="CspWrapper" /> class.
        /// </summary>
        /// <param name="response">The CspDto object returned by the operation..</param>
        ...
        public CspWrapper(CspDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public CspDto Response { get; set; }
