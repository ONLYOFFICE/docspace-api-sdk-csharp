...
namespace DocSpace.API.SDK.Model
{
    ...
    /// MessageArrayWrapper
    /// </summary>
    [DataContract(Name = "MessageArrayWrapper")]
    public partial class MessageArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageArrayWrapper" /> class.
        /// </summary>
        ...
        public MessageArrayWrapper(List<MessageDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
