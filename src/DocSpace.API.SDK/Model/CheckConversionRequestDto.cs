...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CheckConversionRequestDto")]
    public partial class CheckConversionRequestDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckConversionRequestDto" /> class.
        /// </summary>
        ...
        public CheckConversionRequestDto(int fileId = default, bool sync = default, bool startConvert = default, int version = default, string password = default, string outputType = default, bool createNewIfExist = default)
        {
            this.FileId = fileId;
            this.Sync = sync;
