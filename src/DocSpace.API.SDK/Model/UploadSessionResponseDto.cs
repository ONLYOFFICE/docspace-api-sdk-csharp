...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UploadSessionResponseDto")]
    public partial class UploadSessionResponseDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadSessionResponseDto" /> class.
        /// </summary>
        ...
        public UploadSessionResponseDto(int id = default, int folderId = default, int version = default, string title = default, string providerKey = default, bool uploaded = default, FileDto file = default)
        {
            this.Id = id;
