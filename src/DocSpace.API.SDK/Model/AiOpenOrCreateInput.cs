...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiOpenOrCreateInput")]
    public partial class AiOpenOrCreateInput : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiOpenOrCreateInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiOpenOrCreateInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiOpenOrCreateInput" /> class.
        /// </summary>
        ...
        public AiOpenOrCreateInput(string threadId = default, AiProfile profile = default, string profileId = default, AiThreadMessageLike firstMessage = default, string entityId = default)
        {
            // to ensure "profile" is required (not null)
            if (profile == null)
            {
                throw new ArgumentNullException("profile is a required property for AiOpenOrCreateInput and cannot be null");
            }
            this.Profile = profile;
            // to ensure "profileId" is required (not null)
            if (profileId == null)
            {
                throw new ArgumentNullException("profileId is a required property for AiOpenOrCreateInput and cannot be null");
            }
            this.ProfileId = profileId;
            // to ensure "firstMessage" is required (not null)
            if (firstMessage == null)
            {
                throw new ArgumentNullException("firstMessage is a required property for AiOpenOrCreateInput and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AiOpenOrCreateInput {\n");
