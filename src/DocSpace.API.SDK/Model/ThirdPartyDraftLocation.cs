...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ThirdPartyDraftLocation")]
    public partial class ThirdPartyDraftLocation : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyDraftLocation" /> class.
        /// </summary>
        ...
        public ThirdPartyDraftLocation(string folderId = default, string folderTitle = default, string fileId = default, string fileTitle = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThirdPartyDraftLocation {\n");
