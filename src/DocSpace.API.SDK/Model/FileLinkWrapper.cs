...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileLinkWrapper")]
    public partial class FileLinkWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="FileLinkWrapper" /> class.
        /// </summary>
        /// <param name="response">The FileLink object returned by the operation..</param>
        ...
        public FileLinkWrapper(FileLink response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
