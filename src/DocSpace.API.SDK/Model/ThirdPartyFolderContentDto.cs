...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ThirdPartyFolderContentDto")]
    public partial class ThirdPartyFolderContentDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyFolderContentDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ThirdPartyFolderContentDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyFolderContentDto" /> class.
        /// </summary>
        ...
        public ThirdPartyFolderContentDto(List<FileEntryBaseDto> files = default, List<FileEntryBaseDto> folders = default, ThirdPartyFolderDto current = default, Object pathParts = default, int startIndex = default, int count = default, int total = default, int @new = default)
        {
            // to ensure "pathParts" is required (not null)
            if (pathParts == null)
            {
                throw new ArgumentNullException("pathParts is a required property for ThirdPartyFolderContentDto and cannot be null");
            }
        ...
        public ThirdPartyFolderDto Current { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThirdPartyFolderContentDto {\n");
