...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Int64Wrapper")]
    public partial class Int64Wrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="Int64Wrapper" /> class.
        /// </summary>
        /// <param name="response">The int64 value returned by the operation..</param>
        ...
        public Int64Wrapper(int response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
