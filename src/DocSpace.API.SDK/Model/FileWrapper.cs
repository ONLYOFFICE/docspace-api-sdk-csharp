...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileWrapper")]
    public partial class FileWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="FileWrapper" /> class.
        /// </summary>
        /// <param name="response">The FileDto object returned by the operation..</param>
        ...
        public FileWrapper(FileDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        /// <summary>
        /// The FileDto object returned by the operation.
        /// </summary>
        [DataMember(Name = "response", EmitDefaultValue = false)]
        public FileDto Response { get; set; }
