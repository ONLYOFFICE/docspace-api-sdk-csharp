...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NoContentResultWrapper")]
    public partial class NoContentResultWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NoContentResultWrapper" /> class.
        /// </summary>
        ...
        public NoContentResultWrapper(NoContentResult response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public NoContentResult Response { get; set; }
