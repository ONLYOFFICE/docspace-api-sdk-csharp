...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class AiThreadMessageLike : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AiThreadMessageLike" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiThreadMessageLike() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiThreadMessageLike" /> class.
        /// </summary>
        ...
        public AiThreadMessageLike(string id = default, RoleEnum role = default, AiThreadMessageLikeContent content = default, string createdAt = default, AiThreadMessageLikeStatus status = default, Object metadata = default, List<Object> attachments = default)
        {
            this.Role = role;
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for AiThreadMessageLike and cannot be null");
            }
        ...
        public AiThreadMessageLikeContent Content { get; set; }
        ...
        public AiThreadMessageLikeStatus Status { get; set; }
