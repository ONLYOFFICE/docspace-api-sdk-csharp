...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class AiThreadsRenameRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AiThreadsRenameRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiThreadsRenameRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiThreadsRenameRequest" /> class.
        /// </summary>
        /// <param name="threadId">threadId (required).</param>
        /// <param name="title">New thread title. (required).</param>
        public AiThreadsRenameRequest(string threadId = default, string title = default)
        {
            // to ensure "threadId" is required (not null)
            if (threadId == null)
            {
                throw new ArgumentNullException("threadId is a required property for AiThreadsRenameRequest and cannot be null");
            }
            this.ThreadId = threadId;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for AiThreadsRenameRequest and cannot be null");
            }
            this.Title = title;
        }
