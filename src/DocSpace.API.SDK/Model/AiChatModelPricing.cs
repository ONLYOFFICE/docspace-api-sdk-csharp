...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiChatModelPricing")]
    public partial class AiChatModelPricing : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiChatModelPricing" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiChatModelPricing() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiChatModelPricing" /> class.
        /// </summary>
        ...
        /// <param name="price">The price of a chat model, per token. (required).</param>
        public AiChatModelPricing(string id = default, string alias = default, string ownedBy = default, string provider = default, string link = default, AiChatPrice price = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AiChatModelPricing and cannot be null");
            }
            this.Id = id;
            // to ensure "price" is required (not null)
            if (price == null)
            {
                throw new ArgumentNullException("price is a required property for AiChatModelPricing and cannot be null");
            }
            this.Price = price;
            this.Alias = alias;
