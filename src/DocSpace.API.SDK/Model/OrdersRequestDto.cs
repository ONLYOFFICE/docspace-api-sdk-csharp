...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrdersRequestDto")]
    public partial class OrdersRequestDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="OrdersRequestDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrdersRequestDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrdersRequestDto" /> class.
        /// </summary>
        ...
        public OrdersRequestDto(List<OrdersItemRequestDto> items = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for OrdersRequestDto and cannot be null");
            }
            this.Items = items;
        }
        ...
        public List<OrdersItemRequestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrdersRequestDto {\n");
