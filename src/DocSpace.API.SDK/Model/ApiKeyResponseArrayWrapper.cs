...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class ApiKeyResponseArrayWrapper : IValidatableObject
    {
        ...
        public ApiKeyResponseArrayWrapper(List<ApiKeyResponseDto> response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
