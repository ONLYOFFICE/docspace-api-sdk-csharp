...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class AiPromptsUpdateRequestUpdates : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AiPromptsUpdateRequestUpdates" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="text">text.</param>
        /// <param name="folderId">folderId.</param>
        public AiPromptsUpdateRequestUpdates(string name = default, string text = default, string folderId = default)
        {
            this.Name = name;
            this.Text = text;
