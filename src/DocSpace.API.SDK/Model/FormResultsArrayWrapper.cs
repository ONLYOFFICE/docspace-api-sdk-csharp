...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FormResultsArrayWrapper")]
    public partial class FormResultsArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="FormResultsArrayWrapper" /> class.
        /// </summary>
        ...
        public FormResultsArrayWrapper(List<FormResultsDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<FormResultsDto> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormResultsArrayWrapper {\n");
