...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "newAiAiSendCustom_request")]
    public partial class NewAiAiSendCustomRequest : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiSendCustomRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiAiSendCustomRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiSendCustomRequest" /> class.
        /// </summary>
        ...
        public NewAiAiSendCustomRequest(bool isStream = default, string systemPrompt = default, NewAiThreadMessageLike userMessage = default, NewAiAiActionArgs actionArgs = default)
        {
            this.IsStream = isStream;
            // to ensure "systemPrompt" is required (not null)
            if (systemPrompt == null)
            {
                throw new ArgumentNullException("systemPrompt is a required property for NewAiAiSendCustomRequest and cannot be null");
            }
            this.SystemPrompt = systemPrompt;
            // to ensure "userMessage" is required (not null)
            if (userMessage == null)
            {
                throw new ArgumentNullException("userMessage is a required property for NewAiAiSendCustomRequest and cannot be null");
            }
        ...
        public NewAiThreadMessageLike UserMessage { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiAiSendCustomRequest {\n");
