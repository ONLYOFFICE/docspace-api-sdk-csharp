...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiFileEntryDto_allOf_shareSettings")]
    public partial class AiFileEntryDtoAllOfShareSettings : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiFileEntryDtoAllOfShareSettings" /> class.
        /// </summary>
        ...
        public AiFileEntryDtoAllOfShareSettings(int user = default, int externalLink = default, int group = default, int invitationLink = default, int primaryExternalLink = default)
        {
            this.User = user;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AiFileEntryDtoAllOfShareSettings {\n");
