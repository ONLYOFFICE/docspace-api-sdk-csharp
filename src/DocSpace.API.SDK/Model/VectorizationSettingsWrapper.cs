...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VectorizationSettingsWrapper")]
    public partial class VectorizationSettingsWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="VectorizationSettingsWrapper" /> class.
        /// </summary>
        ...
        public VectorizationSettingsWrapper(VectorizationSettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public VectorizationSettingsDto Response { get; set; }
