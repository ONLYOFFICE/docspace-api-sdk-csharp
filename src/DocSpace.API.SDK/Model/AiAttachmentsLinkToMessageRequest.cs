...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class AiAttachmentsLinkToMessageRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AiAttachmentsLinkToMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiAttachmentsLinkToMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiAttachmentsLinkToMessageRequest" /> class.
        /// </summary>
        ...
        public AiAttachmentsLinkToMessageRequest(List<string> ids = default, string messageId = default, string threadId = default)
        {
            // to ensure "ids" is required (not null)
            if (ids == null)
            {
                throw new ArgumentNullException("ids is a required property for AiAttachmentsLinkToMessageRequest and cannot be null");
            }
            this.Ids = ids;
            // to ensure "messageId" is required (not null)
            if (messageId == null)
            {
                throw new ArgumentNullException("messageId is a required property for AiAttachmentsLinkToMessageRequest and cannot be null");
            }
            this.MessageId = messageId;
            // to ensure "threadId" is required (not null)
            if (threadId == null)
            {
                throw new ArgumentNullException("threadId is a required property for AiAttachmentsLinkToMessageRequest and cannot be null");
            }
