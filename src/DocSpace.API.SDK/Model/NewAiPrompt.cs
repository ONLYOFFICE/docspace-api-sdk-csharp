...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiPrompt")]
    public partial class NewAiPrompt : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiPrompt" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiPrompt() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiPrompt" /> class.
        /// </summary>
        ...
        public NewAiPrompt(string id = default, string name = default, string text = default, string folderId = default, decimal createdAt = default, decimal updatedAt = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for NewAiPrompt and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for NewAiPrompt and cannot be null");
            }
            this.Name = name;
            // to ensure "text" is required (not null)
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for NewAiPrompt and cannot be null");
            }
            this.Text = text;
