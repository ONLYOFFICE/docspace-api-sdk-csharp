...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateDocxToolCallParametersDto")]
    public partial class GenerateDocxToolCallParametersDto : IValidatableObject
    {
        ...
        protected GenerateDocxToolCallParametersDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateDocxToolCallParametersDto" /> class.
        /// </summary>
        ...
        public GenerateDocxToolCallParametersDto(string description = default)
        {
            ...
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for GenerateDocxToolCallParametersDto and cannot be null");
            }
