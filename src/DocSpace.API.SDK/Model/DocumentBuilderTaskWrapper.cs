...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class DocumentBuilderTaskWrapper : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">The DocumentBuilderTaskDto object returned by the operation..</param>
        ...
        public DocumentBuilderTaskWrapper(DocumentBuilderTaskDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
