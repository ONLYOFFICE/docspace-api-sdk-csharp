...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiFileOperationDto")]
    public partial class NewAiFileOperationDto : IValidatableObject
    {
        ...
        public NewAiFileOperationType Operation { get; set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name = "status", EmitDefaultValue = false)]
        public NewAiDistributedTaskStatus? Status { get; set; }
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFileOperationDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiFileOperationDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFileOperationDto" /> class.
        /// </summary>
        ...
        public NewAiFileOperationDto(string id = default, NewAiFileOperationType operation = default, int progress = default, string error = default, string processed = default, bool finished = default, string url = default, List<NewAiFileEntryBaseDto> files = default, List<NewAiFileEntryBaseDto> folders = default, NewAiDistributedTaskStatus? status = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for NewAiFileOperationDto and cannot be null");
            }
            this.Id = id;
            ...
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for NewAiFileOperationDto and cannot be null");
            }
            this.Error = error;
            // to ensure "processed" is required (not null)
            if (processed == null)
            {
                throw new ArgumentNullException("processed is a required property for NewAiFileOperationDto and cannot be null");
            }
        ...
        */
        ...
        public List<NewAiFileEntryBaseDto> Files { get; set; }
        ...
        */
        ...
        public List<NewAiFileEntryBaseDto> Folders { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiFileOperationDto {\n");
