...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewItemsAgentNewItemsArrayWrapper")]
    public partial class NewItemsAgentNewItemsArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewItemsAgentNewItemsArrayWrapper" /> class.
        /// </summary>
        ...
        public NewItemsAgentNewItemsArrayWrapper(List<NewItemsDtoAgentNewItemsDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<NewItemsDtoAgentNewItemsDto> Response { get; set; }
