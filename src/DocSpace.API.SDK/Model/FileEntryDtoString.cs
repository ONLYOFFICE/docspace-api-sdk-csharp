...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class FileEntryDtoString : FileEntryBaseDto, IValidatableObject
    {
        ...
        public FileEntryDtoString(string id = default, string rootFolderId = default, string originId = default, string originRoomId = default, string originTitle = default, string originRoomTitle = default, bool canShare = default, FileEntryDtoIntegerAllOfSecurity security = default, string requestToken = default)
        {
            this.Id = id;
