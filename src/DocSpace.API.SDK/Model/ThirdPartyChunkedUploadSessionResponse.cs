...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ThirdPartyChunkedUploadSessionResponse")]
    public partial class ThirdPartyChunkedUploadSessionResponse : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyChunkedUploadSessionResponse" /> class.
        /// </summary>
        ...
        public ThirdPartyChunkedUploadSessionResponse(string id = default, List<string> path = default, DateTime created = default, DateTime expired = default, string location = default, long bytesTotal = default)
        {
            this.Id = id;
            this.Path = path;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThirdPartyChunkedUploadSessionResponse {\n");
