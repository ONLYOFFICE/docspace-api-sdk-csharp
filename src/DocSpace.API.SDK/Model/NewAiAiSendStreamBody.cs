...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiAiSendStreamBody")]
    public partial class NewAiAiSendStreamBody : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiSendStreamBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiAiSendStreamBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiSendStreamBody" /> class.
        /// </summary>
        ...
        public NewAiAiSendStreamBody(string threadId = default, NewAiThreadMessageLike userMessage = default, NewAiAiActionArgs actionArgs = default, string entityId = default, string profileId = default)
        {
            // to ensure "userMessage" is required (not null)
            if (userMessage == null)
            {
                throw new ArgumentNullException("userMessage is a required property for NewAiAiSendStreamBody and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiAiSendStreamBody {\n");
