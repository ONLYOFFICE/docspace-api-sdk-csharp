...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiFolderIntegerArrayWrapper")]
    public partial class NewAiFolderIntegerArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFolderIntegerArrayWrapper" /> class.
        /// </summary>
        ...
        public NewAiFolderIntegerArrayWrapper(List<NewAiFolderDtoInteger> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<NewAiFolderDtoInteger> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiFolderIntegerArrayWrapper {\n");
