...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiFolderContentDtoInteger")]
    public partial class NewAiFolderContentDtoInteger : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFolderContentDtoInteger" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiFolderContentDtoInteger() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFolderContentDtoInteger" /> class.
        /// </summary>
        ...
        public NewAiFolderContentDtoInteger(List<NewAiFileEntryBaseDto> files = default, List<NewAiFileEntryBaseDto> folders = default, NewAiFolderDtoInteger current = default, Object pathParts = default, int startIndex = default, int count = default, int total = default, int @new = default)
        {
            // to ensure "pathParts" is required (not null)
            if (pathParts == null)
            {
                throw new ArgumentNullException("pathParts is a required property for NewAiFolderContentDtoInteger and cannot be null");
            }
        ...
        */
        ...
        public NewAiFolderDtoInteger Current { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiFolderContentDtoInteger {\n");
