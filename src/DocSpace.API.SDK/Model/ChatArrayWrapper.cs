...
namespace DocSpace.API.SDK.Model
{
    ...
    /// ChatArrayWrapper
    /// </summary>
    [DataContract(Name = "ChatArrayWrapper")]
    public partial class ChatArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatArrayWrapper" /> class.
        /// </summary>
        ...
        public ChatArrayWrapper(List<ChatDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<ChatDto> Response { get; set; }
