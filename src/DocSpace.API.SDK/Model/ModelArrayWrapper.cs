...
namespace DocSpace.API.SDK.Model
{
    ...
    /// ModelArrayWrapper
    /// </summary>
    [DataContract(Name = "ModelArrayWrapper")]
    public partial class ModelArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelArrayWrapper" /> class.
        /// </summary>
        ...
        public ModelArrayWrapper(List<ModelDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<ModelDto> Response { get; set; }
