...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiFolderContentDto")]
    public partial class AiFolderContentDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiFolderContentDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiFolderContentDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiFolderContentDto" /> class.
        /// </summary>
        ...
        public AiFolderContentDto(List<AiFileEntryBaseDto> files = default, List<AiFileEntryBaseDto> folders = default, AiFolderDto current = default, Object pathParts = default, int startIndex = default, int count = default, int total = default, int @new = default)
        {
            // to ensure "pathParts" is required (not null)
            if (pathParts == null)
            {
                throw new ArgumentNullException("pathParts is a required property for AiFolderContentDto and cannot be null");
            }
        ...
        public AiFolderDto Current { get; set; }
