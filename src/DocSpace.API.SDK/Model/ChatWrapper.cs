...
namespace DocSpace.API.SDK.Model
{
    ...
    /// ChatWrapper
    /// </summary>
    [DataContract(Name = "ChatWrapper")]
    public partial class ChatWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatWrapper" /> class.
        /// </summary>
        ...
        public ChatWrapper(ChatDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public ChatDto Response { get; set; }
