...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiAiSettingsWrapper")]
    public partial class NewAiAiSettingsWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiSettingsWrapper" /> class.
        /// </summary>
        ...
        public NewAiAiSettingsWrapper(NewAiAiSettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public NewAiAiSettingsDto Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiAiSettingsWrapper {\n");
