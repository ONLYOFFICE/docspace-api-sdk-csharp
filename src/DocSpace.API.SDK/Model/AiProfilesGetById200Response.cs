...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "aiProfilesGetById_200_response")]
    public partial class AiProfilesGetById200Response : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AiProfilesGetById200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiProfilesGetById200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiProfilesGetById200Response" /> class.
        /// </summary>
        ...
        public AiProfilesGetById200Response(string id = default, string name = default, AiProviderType providerType = default, AiBuiltinProviderType? basedOn = default, string baseUrl = default, string modelId = default, bool reasoning = default, decimal capabilities = default, bool canUseTool = default, bool useResponsesApi = default, bool isCloudProvider = default, bool useProxy = default, decimal createdAt = default)
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AiProfilesGetById200Response and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AiProfilesGetById200Response and cannot be null");
            }
            this.Name = name;
            // to ensure "providerType" is required (not null)
            if (providerType == null)
            {
                throw new ArgumentNullException("providerType is a required property for AiProfilesGetById200Response and cannot be null");
            }
            this.ProviderType = providerType;
            // to ensure "baseUrl" is required (not null)
            if (baseUrl == null)
            {
                throw new ArgumentNullException("baseUrl is a required property for AiProfilesGetById200Response and cannot be null");
            }
            this.BaseUrl = baseUrl;
            // to ensure "modelId" is required (not null)
            if (modelId == null)
            {
                throw new ArgumentNullException("modelId is a required property for AiProfilesGetById200Response and cannot be null");
            }
