...
namespace DocSpace.API.SDK.Model
{
    ...
    public enum MessageAction
    {
        ...
        /// <summary>
        /// Enum LoginSuccessViaOAuth for value: 1028
        /// </summary>
        LoginSuccessViaOAuth = 1028,

        /// <summary>
        /// Enum LoginSuccessViaPassword for value: 1029
        /// </summary>
        ...
        /// <summary>
        /// Enum BackupStarted for value: 5041
        /// </summary>
        BackupStarted = 5041,
        ...
        /// <summary>
        /// Enum FolderExternalLinkCreated for value: 5122
        /// </summary>
        FolderExternalLinkCreated = 5122,

        /// <summary>
        /// Enum FolderExternalLinkUpdated for value: 5123
        /// </summary>
        FolderExternalLinkUpdated = 5123,

        /// <summary>
        /// Enum FolderExternalLinkDeleted for value: 5124
        /// </summary>
        FolderExternalLinkDeleted = 5124,

        /// <summary>
        /// Enum BackupCompleted for value: 5125
        /// </summary>
        BackupCompleted = 5125,

        /// <summary>
        /// Enum BackupFailed for value: 5126
        /// </summary>
        BackupFailed = 5126,

        /// <summary>
        /// Enum ScheduledBackupStarted for value: 5127
        /// </summary>
        ScheduledBackupStarted = 5127,

        /// <summary>
        /// Enum ScheduledBackupCompleted for value: 5128
        /// </summary>
        ScheduledBackupCompleted = 5128,

        /// <summary>
        /// Enum ScheduledBackupFailed for value: 5129
        /// </summary>
        ScheduledBackupFailed = 5129,

        /// <summary>
        /// Enum ScheduledBackupDeleted for value: 5130
        /// </summary>
        ScheduledBackupDeleted = 5130,

        /// <summary>
        /// Enum BackupCancelled for value: 5131
        /// </summary>
        BackupCancelled = 5131,

        /// <summary>
        /// Enum RestoreStarted for value: 5132
        /// </summary>
        RestoreStarted = 5132,

        /// <summary>
        /// Enum RestoreCancelled for value: 5133
        /// </summary>
        ...
        /// <summary>
        /// Enum AgentCreated for value: 5154
        /// </summary>
        AgentCreated = 5154,

        /// <summary>
        /// Enum AgentRenamed for value: 5155
        /// </summary>
        AgentRenamed = 5155,

        /// <summary>
        /// Enum AgentDeleted for value: 5156
        /// </summary>
        AgentDeleted = 5156,

        /// <summary>
        /// Enum AddedServerToAgent for value: 5157
        /// </summary>
        AddedServerToAgent = 5157,

        /// <summary>
        /// Enum DeletedServerFromAgent for value: 5158
        /// </summary>
        DeletedServerFromAgent = 5158,

        /// <summary>
        /// Enum RoomChangeOwner for value: 5159
        /// </summary>
        RoomChangeOwner = 5159,

        /// <summary>
        /// Enum DocumentsDefaultTemplatesSettingsUpdated for value: 5160
        /// </summary>
        DocumentsDefaultTemplatesSettingsUpdated = 5160,

        /// <summary>
        /// Enum PrivacyRoomKeyCreated for value: 5161
        /// </summary>
        PrivacyRoomKeyCreated = 5161,

        /// <summary>
        /// Enum PrivacyRoomKeyUpdated for value: 5162
        /// </summary>
        PrivacyRoomKeyUpdated = 5162,

        /// <summary>
        /// Enum PrivacyRoomKeyDeleted for value: 5163
        /// </summary>
        PrivacyRoomKeyDeleted = 5163,

        /// <summary>
        /// Enum FileSavedButUserQuotaExceeded for value: 5201
        /// </summary>
        FileSavedButUserQuotaExceeded = 5201,

        /// <summary>
        /// Enum FileNotSavedDueToUserQuota for value: 5202
        /// </summary>
        FileNotSavedDueToUserQuota = 5202,

        /// <summary>
        /// Enum FileSavedButRoomQuotaExceeded for value: 5203
        /// </summary>
        FileSavedButRoomQuotaExceeded = 5203,

        /// <summary>
        /// Enum FileNotSavedDueToRoomQuota for value: 5204
        /// </summary>
        FileNotSavedDueToRoomQuota = 5204,

        /// <summary>
        /// Enum FileSavedButTenantQuotaExceeded for value: 5205
        /// </summary>
        FileSavedButTenantQuotaExceeded = 5205,

        /// <summary>
        /// Enum FileNotSavedDueToTenantQuota for value: 5206
        /// </summary>
        FileNotSavedDueToTenantQuota = 5206,

        /// <summary>
        /// Enum DocumentsShowQuickActionsUpdated for value: 5207
        /// </summary>
        ...
        /// <summary>
        /// Enum CustomerWalletServicesSettingsUpdated for value: 6067
        /// </summary>
        CustomerWalletServicesSettingsUpdated = 6067,

        /// <summary>
        /// Enum QuotaPerAiAgentChanged for value: 6068
        /// </summary>
        QuotaPerAiAgentChanged = 6068,

        /// <summary>
        /// Enum QuotaPerAiAgentDisabled for value: 6069
        /// </summary>
        QuotaPerAiAgentDisabled = 6069,

        /// <summary>
        /// Enum CustomQuotaPerAiAgentDefault for value: 6070
        /// </summary>
        CustomQuotaPerAiAgentDefault = 6070,

        /// <summary>
        /// Enum CustomQuotaPerAiAgentChanged for value: 6071
        /// </summary>
        CustomQuotaPerAiAgentChanged = 6071,

        /// <summary>
        /// Enum CustomQuotaPerAiAgentDisabled for value: 6072
        /// </summary>
        CustomQuotaPerAiAgentDisabled = 6072,

        /// <summary>
        /// Enum AIProviderCreated for value: 6073
        /// </summary>
        AIProviderCreated = 6073,

        /// <summary>
        /// Enum AIProviderUpdated for value: 6074
        /// </summary>
        AIProviderUpdated = 6074,

        /// <summary>
        /// Enum AIProviderDeleted for value: 6075
        /// </summary>
        AIProviderDeleted = 6075,

        /// <summary>
        /// Enum ServerCreated for value: 6076
        /// </summary>
        ServerCreated = 6076,

        /// <summary>
        /// Enum ServerUpdated for value: 6077
        /// </summary>
        ServerUpdated = 6077,

        /// <summary>
        /// Enum ServerEnabled for value: 6078
        /// </summary>
        ServerEnabled = 6078,

        /// <summary>
        /// Enum ServerDisabled for value: 6079
        /// </summary>
        ServerDisabled = 6079,

        /// <summary>
        /// Enum ServerDeleted for value: 6080
        /// </summary>
        ServerDeleted = 6080,

        /// <summary>
        /// Enum SetWebSearchSettings for value: 6081
        /// </summary>
        SetWebSearchSettings = 6081,

        /// <summary>
        /// Enum ResetWebSearchSettings for value: 6082
        /// </summary>
        ResetWebSearchSettings = 6082,

        /// <summary>
        /// Enum SetVectorizationSettings for value: 6083
        /// </summary>
        SetVectorizationSettings = 6083,

        /// <summary>
        /// Enum ResetVectorizationSettings for value: 6084
        /// </summary>
        ResetVectorizationSettings = 6084,

        /// <summary>
        /// Enum WebpluginUploaded for value: 6085
        /// </summary>
        WebpluginUploaded = 6085,

        /// <summary>
        /// Enum WebpluginUpdated for value: 6086
        /// </summary>
        WebpluginUpdated = 6086,

        /// <summary>
        /// Enum WebpluginDeleted for value: 6087
        /// </summary>
        WebpluginDeleted = 6087,

        /// <summary>
        /// Enum WhiteLabelSettingsLogoTextUpdated for value: 6088
        /// </summary>
        WhiteLabelSettingsLogoTextUpdated = 6088,

        /// <summary>
        /// Enum WhiteLabelSettingsLogosUpdated for value: 6089
        /// </summary>
        WhiteLabelSettingsLogosUpdated = 6089,

        /// <summary>
        /// Enum WhiteLabelCompanySettingsUpdated for value: 6090
        /// </summary>
        WhiteLabelCompanySettingsUpdated = 6090,

        /// <summary>
        /// Enum WhiteLabelAdditionalSettingsUpdated for value: 6091
        /// </summary>
        WhiteLabelAdditionalSettingsUpdated = 6091,

        /// <summary>
        /// Enum WhiteLabelMailSettingsUpdated for value: 6092
        /// </summary>
        WhiteLabelMailSettingsUpdated = 6092,

        /// <summary>
        /// Enum InvitationSettingsUpdated for value: 6093
        /// </summary>
        InvitationSettingsUpdated = 6093,

        /// <summary>
        /// Enum IPRestrictionsSettingsUpdated for value: 6094
        /// </summary>
        IPRestrictionsSettingsUpdated = 6094,

        /// <summary>
        /// Enum LoginSettingsUpdated for value: 6095
        /// </summary>
        LoginSettingsUpdated = 6095,

        /// <summary>
        /// Enum AIDefaultProviderSet for value: 6096
        /// </summary>
        AIDefaultProviderSet = 6096,

        /// <summary>
        /// Enum AIAccessEnabled for value: 6097
        /// </summary>
        AIAccessEnabled = 6097,

        /// <summary>
        /// Enum AIAccessDisabled for value: 6098
        /// </summary>
        AIAccessDisabled = 6098,

        /// <summary>
        /// Enum UserUpdatedAiSettings for value: 6099
        /// </summary>
        UserUpdatedAiSettings = 6099,

        /// <summary>
        /// Enum SubscriptionBalanceMovedToWallet for value: 6100
        /// </summary>
        SubscriptionBalanceMovedToWallet = 6100,

        /// <summary>
        /// Enum DocsCloudConfigUpdated for value: 6101
        /// </summary>
        DocsCloudConfigUpdated = 6101,

        /// <summary>
        /// Enum DocsCloudQuotaReportDownloaded for value: 6102
        /// </summary>
        DocsCloudQuotaReportDownloaded = 6102,

        /// <summary>
        /// Enum AiProfileCreated for value: 6103
        /// </summary>
        AiProfileCreated = 6103,

        /// <summary>
        /// Enum AiProfileUpdated for value: 6104
        /// </summary>
        AiProfileUpdated = 6104,

        /// <summary>
        /// Enum AiProfileDeleted for value: 6105
        /// </summary>
        AiProfileDeleted = 6105,

        /// <summary>
        /// Enum AiProfileAssigned for value: 6106
        /// </summary>
        AiProfileAssigned = 6106,

        /// <summary>
        /// Enum AiProfileUnassigned for value: 6107
        /// </summary>
        AiProfileUnassigned = 6107,

        /// <summary>
        /// Enum AiAgentProfileAssigned for value: 6108
        /// </summary>
        AiAgentProfileAssigned = 6108,

        /// <summary>
        /// Enum UpdatedServerOfAgent for value: 6109
        /// </summary>
        ...
        /// <summary>
        /// Enum SuspiciousLoginDetected for value: 7005
        /// </summary>
