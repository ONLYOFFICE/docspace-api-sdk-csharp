...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class FileEntryDtoIntegerAllOfShareSettings : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileEntryDtoIntegerAllOfShareSettings" /> class.
        /// </summary>
        ...
        public FileEntryDtoIntegerAllOfShareSettings(int user = default, int externalLink = default, int group = default, int invitationLink = default, int primaryExternalLink = default)
        {
            this.User = user;
