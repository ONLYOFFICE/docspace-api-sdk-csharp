...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DraftLocationString")]
    public partial class DraftLocationString : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="DraftLocationString" /> class.
        /// </summary>
        ...
        public DraftLocationString(string folderId = default, string folderTitle = default, string fileId = default, string fileTitle = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DraftLocationString {\n");
