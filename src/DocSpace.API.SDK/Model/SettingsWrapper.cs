...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SettingsWrapper")]
    public partial class SettingsWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingsWrapper" /> class.
        /// </summary>
        /// <param name="response">The SettingsDto object returned by the operation..</param>
        ...
        public SettingsWrapper(SettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public SettingsDto Response { get; set; }
