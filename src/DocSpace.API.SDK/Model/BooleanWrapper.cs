...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BooleanWrapper")]
    public partial class BooleanWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanWrapper" /> class.
        /// </summary>
        /// <param name="response">The boolean value returned by the operation..</param>
        ...
        public BooleanWrapper(bool response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
