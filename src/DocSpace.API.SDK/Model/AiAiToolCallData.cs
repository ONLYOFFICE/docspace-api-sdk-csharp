...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class AiAiToolCallData : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AiAiToolCallData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiAiToolCallData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiAiToolCallData" /> class.
        /// </summary>
        ...
        public AiAiToolCallData(string threadId = default, string messageId = default, decimal idx = default, AiThreadMessageLike message = default, AiAiActionArgs actionArgs = default, string entityId = default, string profileId = default)
        {
            ...
            if (threadId == null)
            {
                throw new ArgumentNullException("threadId is a required property for AiAiToolCallData and cannot be null");
            }
            this.ThreadId = threadId;
            // to ensure "messageId" is required (not null)
            if (messageId == null)
            {
                throw new ArgumentNullException("messageId is a required property for AiAiToolCallData and cannot be null");
            }
            ...
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for AiAiToolCallData and cannot be null");
            }
