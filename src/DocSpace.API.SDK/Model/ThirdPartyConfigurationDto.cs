...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ThirdPartyConfigurationDto")]
    public partial class ThirdPartyConfigurationDto : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyConfigurationDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ThirdPartyConfigurationDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyConfigurationDto" /> class.
        /// </summary>
        ...
        public ThirdPartyConfigurationDto(DocumentConfigDto document = default, string documentType = default, EditorConfigurationDto editorConfig = default, EditorType editorType = default, string editorUrl = default, string token = default, string type = default, ThirdPartyFileDto file = default, string errorMessage = default, bool? startFilling = default, bool? fillingStatus = default, StartFillingMode? startFillingMode = default, string fillingSessionId = default, QuotaScope? quotaExceededScope = default, EditorToolCallStateDto generationToolCallState = default)
        {
            // to ensure "document" is required (not null)
            if (document == null)
            {
                throw new ArgumentNullException("document is a required property for ThirdPartyConfigurationDto and cannot be null");
            }
            this.Document = document;
            // to ensure "documentType" is required (not null)
            if (documentType == null)
            {
                throw new ArgumentNullException("documentType is a required property for ThirdPartyConfigurationDto and cannot be null");
            }
            this.DocumentType = documentType;
            // to ensure "editorConfig" is required (not null)
            if (editorConfig == null)
            {
                throw new ArgumentNullException("editorConfig is a required property for ThirdPartyConfigurationDto and cannot be null");
            }
            ...
            if (editorUrl == null)
            {
                throw new ArgumentNullException("editorUrl is a required property for ThirdPartyConfigurationDto and cannot be null");
            }
            this.EditorUrl = editorUrl;
            // to ensure "file" is required (not null)
            if (file == null)
            {
                throw new ArgumentNullException("file is a required property for ThirdPartyConfigurationDto and cannot be null");
            }
            this.File = file;
            this.Token = token;
            this.Type = type;
        ...
        public ThirdPartyFileDto File { get; set; }
