...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiImportError")]
    public partial class NewAiImportError : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiImportError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiImportError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiImportError" /> class.
        /// </summary>
        ...
        public NewAiImportError(KindEnum kind = default, string @ref = default, NewAiTErrorData error = default)
        {
            this.Kind = kind;
            // to ensure "@ref" is required (not null)
            if (@ref == null)
            {
                throw new ArgumentNullException("@ref is a required property for NewAiImportError and cannot be null");
            }
            this.Ref = @ref;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for NewAiImportError and cannot be null");
            }
            this.Error = error;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiImportError {\n");
