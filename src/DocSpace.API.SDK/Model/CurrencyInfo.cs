...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class CurrencyInfo : IValidatableObject
    {
        ...
        public CurrencyInfo(string code = default, string symbol = default)
        {
            ...
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for CurrencyInfo and cannot be null");
            }
            this.Code = code;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for CurrencyInfo and cannot be null");
            }
            this.Symbol = symbol;
        }
