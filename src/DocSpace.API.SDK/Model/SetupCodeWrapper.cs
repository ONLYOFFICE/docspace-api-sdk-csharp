...
namespace DocSpace.API.SDK.Model
{
    ...
    /// SetupCodeWrapper
    /// </summary>
    [DataContract(Name = "SetupCodeWrapper")]
    public partial class SetupCodeWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="SetupCodeWrapper" /> class.
        /// </summary>
        ...
        public SetupCodeWrapper(SetupCode response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public SetupCode Response { get; set; }
