...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class TenantWalletServiceSettingsWrapper : IValidatableObject
    {
        ...
        public TenantWalletServiceSettingsWrapper(TenantWalletServiceSettings response = default, int count = default, List<ActiveConnectionsWrapperLinksInner> links = default, int status = default, int statusCode = default)
        {
