...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class AiVectorizationSettingsWrapper : IValidatableObject
    {
        ...
        public AiVectorizationSettingsWrapper(AiVectorizationSettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AiVectorizationSettingsWrapper {\n");
