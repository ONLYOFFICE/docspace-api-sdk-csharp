...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiFolderContentIntegerWrapper")]
    public partial class NewAiFolderContentIntegerWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFolderContentIntegerWrapper" /> class.
        /// </summary>
        ...
        public NewAiFolderContentIntegerWrapper(NewAiFolderContentDtoInteger response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public NewAiFolderContentDtoInteger Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiFolderContentIntegerWrapper {\n");
