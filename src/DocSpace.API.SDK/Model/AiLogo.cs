...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiLogo")]
    public partial class AiLogo : IValidatableObject
    {
        ...
        public AiLogo(string original = default, string large = default, string medium = default, string small = default, string color = default, AiLogoCover cover = default)
        {
            // to ensure "original" is required (not null)
            if (original == null)
            {
                throw new ArgumentNullException("original is a required property for AiLogo and cannot be null");
            }
            this.Original = original;
            // to ensure "large" is required (not null)
            if (large == null)
            {
                throw new ArgumentNullException("large is a required property for AiLogo and cannot be null");
            }
            this.Large = large;
            // to ensure "medium" is required (not null)
            if (medium == null)
            {
                throw new ArgumentNullException("medium is a required property for AiLogo and cannot be null");
            }
            this.Medium = medium;
            // to ensure "small" is required (not null)
            if (small == null)
            {
                throw new ArgumentNullException("small is a required property for AiLogo and cannot be null");
            }
            this.Small = small;
            this.Color = color;
            this.Cover = cover;
        ...
        public AiLogoCover Cover { get; set; }
