...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class EditHistoryChangesWrapper : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="user">The user who edited the file..</param>
        /// <param name="created">The creation date and time of the file version..</param>
        /// <param name="documentSha256">The document hash generated by the SHA-256 algorithm..</param>
        public EditHistoryChangesWrapper(EditHistoryAuthor user = default, DateTime? created = default, string documentSha256 = default)
        {
            this.User = user;
