...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiUserSettingsWrapper")]
    public partial class AiUserSettingsWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiUserSettingsWrapper" /> class.
        /// </summary>
        ...
        public AiUserSettingsWrapper(AiUserSettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public AiUserSettingsDto Response { get; set; }
