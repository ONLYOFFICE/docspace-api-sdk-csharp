...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class EmployeeWrapper : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">The EmployeeDto object returned by the operation..</param>
        ...
        public EmployeeWrapper(EmployeeDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
