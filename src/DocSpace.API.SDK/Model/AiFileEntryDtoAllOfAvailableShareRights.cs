...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiFileEntryDto_allOf_availableShareRights")]
    public partial class AiFileEntryDtoAllOfAvailableShareRights : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiFileEntryDtoAllOfAvailableShareRights" /> class.
        /// </summary>
        ...
        public AiFileEntryDtoAllOfAvailableShareRights(List<string> user = default, List<string> externalLink = default, List<string> group = default, List<string> invitationLink = default, List<string> primaryExternalLink = default)
        {
            this.User = user;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AiFileEntryDtoAllOfAvailableShareRights {\n");
