...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiFolderDtoInteger")]
    public partial class AiFolderDtoInteger : AiFileEntryDtoInteger, IValidatableObject
    {
        ...
        public AiRoomType? RoomType { get; set; }

        /// <summary>
        /// The folder type.
        /// </summary>
        [DataMember(Name = "type", EmitDefaultValue = false)]
        public AiFolderType? Type { get; set; }
        ...
        public AiRoomType? RootRoomType { get; set; }
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiFolderDtoInteger" /> class.
        /// </summary>
        ...
        public AiFolderDtoInteger(int parentId = default, int filesCount = default, int foldersCount = default, bool? isShareable = default, int @new = default, bool mute = default, List<string> tags = default, AiLogo logo = default, bool pinned = default, AiRoomType? roomType = default, bool @private = default, bool indexing = default, bool denyDownload = default, AiRoomDataLifetimeDto lifetime = default, AiWatermarkDto watermark = default, AiFolderType? type = default, bool? inRoom = default, long? quotaLimit = default, bool? isCustomQuota = default, long? usedSpace = default, bool? passwordProtected = default, bool? expired = default, AiChatSettingsDto chatSettings = default, AiRoomType? rootRoomType = default, bool? saveFormAsXLSX = default, bool? sendFormToExternalDB = default, int? originalFormId = default)
        {
        ...
        public AiRoomDataLifetimeDto Lifetime { get; set; }

        /// <summary>
        /// The watermark settings of the folder.
        /// </summary>
        [DataMember(Name = "watermark", EmitDefaultValue = false)]
        public AiWatermarkDto Watermark { get; set; }
        ...
        public AiChatSettingsDto ChatSettings { get; set; }
