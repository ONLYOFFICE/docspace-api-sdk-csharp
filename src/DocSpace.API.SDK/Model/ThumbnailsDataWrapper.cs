...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class ThumbnailsDataWrapper : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">The ThumbnailsDataDto object returned by the operation..</param>
        ...
        public ThumbnailsDataWrapper(ThumbnailsDataDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
