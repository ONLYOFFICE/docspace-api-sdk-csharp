...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreditAiBalanceRequestDto")]
    public partial class CreditAiBalanceRequestDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditAiBalanceRequestDto" /> class.
        /// </summary>
        /// <param name="amount">The amount to transfer from the main balance to the AI subaccount..</param>
        /// <param name="currency">The three-character ISO 4217 currency symbol..</param>
        public CreditAiBalanceRequestDto(double amount = default, string currency = default)
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The amount to transfer from the main balance to the AI subaccount.</value>
        /*
