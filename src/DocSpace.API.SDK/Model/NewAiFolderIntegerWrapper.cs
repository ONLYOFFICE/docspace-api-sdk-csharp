...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiFolderIntegerWrapper")]
    public partial class NewAiFolderIntegerWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiFolderIntegerWrapper" /> class.
        /// </summary>
        ...
        public NewAiFolderIntegerWrapper(NewAiFolderDtoInteger response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public NewAiFolderDtoInteger Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiFolderIntegerWrapper {\n");
