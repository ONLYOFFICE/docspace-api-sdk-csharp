...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ThirdPartyUploadSessionResponseDto")]
    public partial class ThirdPartyUploadSessionResponseDto : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyUploadSessionResponseDto" /> class.
        /// </summary>
        ...
        public ThirdPartyUploadSessionResponseDto(string id = default, string folderId = default, int version = default, string title = default, string providerKey = default, bool uploaded = default, ThirdPartyFileDto file = default)
        {
            this.Id = id;
