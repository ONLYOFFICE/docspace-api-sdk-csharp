...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServicePaymentWrapper")]
    public partial class ServicePaymentWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ServicePaymentWrapper" /> class.
        /// </summary>
        ...
        public ServicePaymentWrapper(ServicePayment response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public ServicePayment Response { get; set; }
