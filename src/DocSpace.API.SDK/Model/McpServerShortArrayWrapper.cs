...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "McpServerShortArrayWrapper")]
    public partial class McpServerShortArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="McpServerShortArrayWrapper" /> class.
        /// </summary>
        ...
        public McpServerShortArrayWrapper(List<McpServerShortDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<McpServerShortDto> Response { get; set; }
