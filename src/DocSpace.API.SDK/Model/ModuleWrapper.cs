...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModuleWrapper")]
    public partial class ModuleWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleWrapper" /> class.
        /// </summary>
        /// <param name="response">The Module object returned by the operation..</param>
        ...
        public ModuleWrapper(Module response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public Module Response { get; set; }
