...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "newAiAiApproveToolCall_request")]
    public partial class NewAiAiApproveToolCallRequest : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiApproveToolCallRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAiAiApproveToolCallRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiApproveToolCallRequest" /> class.
        /// </summary>
        ...
        public NewAiAiApproveToolCallRequest(Object result = default, bool allowAlways = default, string threadId = default, string messageId = default, decimal idx = default, NewAiThreadMessageLike message = default, NewAiAiActionArgs actionArgs = default, string entityId = default, string profileId = default)
        {
            // to ensure "result" is required (not null)
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for NewAiAiApproveToolCallRequest and cannot be null");
            }
            this.Result = result;
            // to ensure "threadId" is required (not null)
            if (threadId == null)
            {
                throw new ArgumentNullException("threadId is a required property for NewAiAiApproveToolCallRequest and cannot be null");
            }
            this.ThreadId = threadId;
            // to ensure "messageId" is required (not null)
            if (messageId == null)
            {
                throw new ArgumentNullException("messageId is a required property for NewAiAiApproveToolCallRequest and cannot be null");
            }
            ...
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for NewAiAiApproveToolCallRequest and cannot be null");
            }
        ...
        public NewAiThreadMessageLike Message { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiAiApproveToolCallRequest {\n");
