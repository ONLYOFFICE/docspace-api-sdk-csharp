...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiTMCPItem")]
    public partial class AiTMCPItem : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AiTMCPItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AiTMCPItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiTMCPItem" /> class.
        /// </summary>
        ...
        public AiTMCPItem(string name = default, string description = default, Object inputSchema = default, bool enabled = default, string serverType = default, bool requireApproval = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AiTMCPItem and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for AiTMCPItem and cannot be null");
            }
            this.Description = description;
            // to ensure "inputSchema" is required (not null)
            if (inputSchema == null)
            {
                throw new ArgumentNullException("inputSchema is a required property for AiTMCPItem and cannot be null");
            }
