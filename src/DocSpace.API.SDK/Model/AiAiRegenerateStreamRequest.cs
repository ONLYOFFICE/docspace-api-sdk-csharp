...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "aiAiRegenerateStream_request")]
    public partial class AiAiRegenerateStreamRequest : IValidatableObject
    {
        ...
        protected AiAiRegenerateStreamRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiAiRegenerateStreamRequest" /> class.
        /// </summary>
        ...
        public AiAiRegenerateStreamRequest(string threadId = default, AiAiActionArgs actionArgs = default, string entityId = default, string profileId = default)
        {
            ...
            if (threadId == null)
            {
                throw new ArgumentNullException("threadId is a required property for AiAiRegenerateStreamRequest and cannot be null");
            }
