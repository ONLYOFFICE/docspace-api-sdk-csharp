...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModelSettingsArrayWrapper")]
    public partial class ModelSettingsArrayWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelSettingsArrayWrapper" /> class.
        /// </summary>
        ...
        public ModelSettingsArrayWrapper(List<ModelSettingsDto> response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public List<ModelSettingsDto> Response { get; set; }
