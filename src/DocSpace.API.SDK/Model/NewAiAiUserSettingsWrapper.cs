...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewAiAiUserSettingsWrapper")]
    public partial class NewAiAiUserSettingsWrapper : IValidatableObject
    {
    
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAiAiUserSettingsWrapper" /> class.
        /// </summary>
        ...
        public NewAiAiUserSettingsWrapper(NewAiAiUserSettingsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
        ...
        public NewAiAiUserSettingsDto Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAiAiUserSettingsWrapper {\n");
