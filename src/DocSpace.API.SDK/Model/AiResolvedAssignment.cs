...
namespace DocSpace.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AiResolvedAssignment")]
    public partial class AiResolvedAssignment : IValidatableObject
    {
        ...
        protected AiResolvedAssignment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AiResolvedAssignment" /> class.
        /// </summary>
        ...
        public AiResolvedAssignment(string profileId = default, AiProfile profile = default)
        {
            ...
            if (profileId == null)
            {
                throw new ArgumentNullException("profileId is a required property for AiResolvedAssignment and cannot be null");
            }
            this.ProfileId = profileId;
            // to ensure "profile" is required (not null)
            if (profile == null)
            {
                throw new ArgumentNullException("profile is a required property for AiResolvedAssignment and cannot be null");
            }
