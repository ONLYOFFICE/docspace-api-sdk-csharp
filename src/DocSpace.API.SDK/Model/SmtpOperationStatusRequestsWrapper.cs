...
namespace DocSpace.API.SDK.Model
{
    ...
    public partial class SmtpOperationStatusRequestsWrapper : IValidatableObject
    {
        ...
        public SmtpOperationStatusRequestsWrapper(SmtpOperationStatusRequestsDto response = default, int count = default, List<GetPortalPrices200ResponseLinksInner> links = default, int status = default, int statusCode = default)
        {
