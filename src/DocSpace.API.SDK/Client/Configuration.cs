...
namespace DocSpace.API.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "3.2.1-preview.1";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/3.2.1-preview.1/csharp");
        ...
        public Configuration(
            ...
            string basePath = "http://localhost:8092") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 3.2.1-preview.1\n";
