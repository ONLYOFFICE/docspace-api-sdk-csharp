...
*AuthorizationApi* | [**Oauth2AuthorizeGet**](docs/AuthorizationApi.md#oauth2authorizeget) | **GET** /oauth2/authorize | OAuth2 Authorization Endpoint
*AuthorizationApi* | [**Oauth2AuthorizePost**](docs/AuthorizationApi.md#oauth2authorizepost) | **POST** /oauth2/authorize | OAuth2 Consent Endpoint
*AuthorizationApi* | [**Oauth2TokenPost**](docs/AuthorizationApi.md#oauth2tokenpost) | **POST** /oauth2/token | OAuth2 Token Endpoint
...
*ClientManagementApi* | [**ChangeActivation**](docs/ClientManagementApi.md#changeactivation) | **PATCH** /api/2.0/clients/{clientId}/activation | Change client activation status
*ClientManagementApi* | [**CreateClient**](docs/ClientManagementApi.md#createclient) | **POST** /api/2.0/clients | Create a new OAuth2 client
*ClientManagementApi* | [**DeleteClient**](docs/ClientManagementApi.md#deleteclient) | **DELETE** /api/2.0/clients/{clientId} | Delete an OAuth2 client
*ClientManagementApi* | [**RegenerateSecret**](docs/ClientManagementApi.md#regeneratesecret) | **PATCH** /api/2.0/clients/{clientId}/regenerate | Regenerate client secret
*ClientManagementApi* | [**RevokeUserClient**](docs/ClientManagementApi.md#revokeuserclient) | **DELETE** /api/2.0/clients/{clientId}/revoke | Revoke client consent
*ClientManagementApi* | [**UpdateClient**](docs/ClientManagementApi.md#updateclient) | **PUT** /api/2.0/clients/{clientId} | Update an existing OAuth2 client
*ClientQueryingApi* | [**GetClient**](docs/ClientQueryingApi.md#getclient) | **GET** /api/2.0/clients/{clientId} | Get client details
*ClientQueryingApi* | [**GetClientInfo**](docs/ClientQueryingApi.md#getclientinfo) | **GET** /api/2.0/clients/{clientId}/info | Retrieves detailed information for a specific client
*ClientQueryingApi* | [**GetClients**](docs/ClientQueryingApi.md#getclients) | **GET** /api/2.0/clients | List clients
*ClientQueryingApi* | [**GetClientsInfo**](docs/ClientQueryingApi.md#getclientsinfo) | **GET** /api/2.0/clients/info | Retrieves a pageable list of client information
*ClientQueryingApi* | [**GetConsents**](docs/ClientQueryingApi.md#getconsents) | **GET** /api/2.0/clients/consents | Retrieves a pageable list of consents
*ClientQueryingApi* | [**GetPublicClientInfo**](docs/ClientQueryingApi.md#getpublicclientinfo) | **GET** /api/2.0/clients/{clientId}/public/info | Handles the GET request for public client information
...
*ScopeManagementApi* | [**GetScopes**](docs/ScopeManagementApi.md#getscopes) | **GET** /api/2.0/scopes | List available OAuth2 scopes
...
## Documentation for Models
 ...
 - [Model.Oauth2TokenPost200Response](docs/Oauth2TokenPost200Response.md)
