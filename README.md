# Docspace - the C# library for the ASC.Web.Api
...
*FilesFilesApi* | [**CheckFillFormDraft**](docs/FilesFilesApi.md#checkfillformdraft) | **POST** /api/2.0/files/masterform/{fileId}/checkfillformdraft | Check the form draft
...
*FilesFilesApi* | [**CreateTextFile**](docs/FilesFilesApi.md#createtextfile) | **POST** /api/2.0/files/{folderId}/text | Create a txt file
...
*FilesFilesApi* | [**CreateThumbnails**](docs/FilesFilesApi.md#createthumbnails) | **POST** /api/2.0/files/thumbnails | Create thumbnails
...
*FilesFilesApi* | [**GetFillResult**](docs/FilesFilesApi.md#getfillresult) | **GET** /api/2.0/files/file/fillresult | Gets fill result
...
*FilesFilesApi* | [**OpenEdit**](docs/FilesFilesApi.md#openedit) | **GET** /api/2.0/files/file/{fileId}/openedit | Open a file
*FilesFilesApi* | [**ProtectUsers**](docs/FilesFilesApi.md#protectusers) | **GET** /api/2.0/files/file/{fileId}/protectusers | Get users with the access to the protected file
...
*FilesFilesApi* | [**SaveAsPdf**](docs/FilesFilesApi.md#saveaspdf) | **POST** /api/2.0/files/file/{id}/saveaspdf | Save as pdf
...
*FilesFilesApi* | [**SetFilesOrder**](docs/FilesFilesApi.md#setfilesorder) | **PUT** /api/2.0/files/order | Sets order
*FilesFilesApi* | [**SetOrderFile**](docs/FilesFilesApi.md#setorderfile) | **PUT** /api/2.0/files/{fileId}/order | Sets order of a file with ID specified in the request
*FilesFilesApi* | [**StartEdit**](docs/FilesFilesApi.md#startedit) | **POST** /api/2.0/files/file/{fileId}/startedit | Start file editing
*FilesFilesApi* | [**StartFilling**](docs/FilesFilesApi.md#startfilling) | **PUT** /api/2.0/files/file/{fileId}/startfilling | Starts filling
...
*FilesFoldersApi* | [**CheckUpload**](docs/FilesFoldersApi.md#checkupload) | **POST** /api/2.0/files/{folderId}/upload/check | Checks upload
...
*FilesFoldersApi* | [**SetFileOrder**](docs/FilesFoldersApi.md#setfileorder) | **PUT** /api/2.0/files/folder/{folderId}/order | Sets file order in the folder with ID specified in the request
...
*FilesOperationsApi* | [**CopyBatchItems**](docs/FilesOperationsApi.md#copybatchitems) | **PUT** /api/2.0/files/fileops/copy | Copy to a folder
...
*FilesOperationsApi* | [**DeleteFileVersions**](docs/FilesOperationsApi.md#deletefileversions) | **PUT** /api/2.0/files/fileops/deleteversion | 
*FilesOperationsApi* | [**DuplicateBatchItems**](docs/FilesOperationsApi.md#duplicatebatchitems) | **PUT** /api/2.0/files/fileops/duplicate | Duplicates all the selected files and folders
...
*FilesOperationsApi* | [**GetOperationStatuses**](docs/FilesOperationsApi.md#getoperationstatuses) | **GET** /api/2.0/files/fileops | Get active operations
*FilesOperationsApi* | [**GetOperationStatusesByType**](docs/FilesOperationsApi.md#getoperationstatusesbytype) | **GET** /api/2.0/files/fileops/{operationType} | Retrieves the statuses of operations filtered by the specified operation type.
*FilesOperationsApi* | [**MarkAsRead**](docs/FilesOperationsApi.md#markasread) | **PUT** /api/2.0/files/fileops/markasread | Mark as read
*FilesOperationsApi* | [**MoveBatchItems**](docs/FilesOperationsApi.md#movebatchitems) | **PUT** /api/2.0/files/fileops/move | Move to a folder
*FilesOperationsApi* | [**MoveOrCopyBatchCheck**](docs/FilesOperationsApi.md#moveorcopybatchcheck) | **GET** /api/2.0/files/fileops/move | Check files and folders for conflicts
*FilesOperationsApi* | [**MoveOrCopyDestFolderCheck**](docs/FilesOperationsApi.md#moveorcopydestfoldercheck) | **GET** /api/2.0/files/fileops/checkdestfolder | Moves or copies
...
*FilesQuotaApi* | [**ResetRoomQuota**](docs/FilesQuotaApi.md#resetroomquota) | **PUT** /api/2.0/files/rooms/resetquota | Reset a room quota limit
*FilesQuotaApi* | [**UpdateRoomsQuota**](docs/FilesQuotaApi.md#updateroomsquota) | **PUT** /api/2.0/files/rooms/roomquota | Change a room quota limit
*FilesRoomsApi* | [**AddTags**](docs/FilesRoomsApi.md#addtags) | **PUT** /api/2.0/files/rooms/{id}/tags | Add room tags
*FilesRoomsApi* | [**ArchiveRoom**](docs/FilesRoomsApi.md#archiveroom) | **PUT** /api/2.0/files/rooms/{id}/archive | Archive a room
*FilesRoomsApi* | [**ChangeRoomCover**](docs/FilesRoomsApi.md#changeroomcover) | **POST** /api/2.0/files/rooms/{id}/cover | Changes room cover
*FilesRoomsApi* | [**CreateRoom**](docs/FilesRoomsApi.md#createroom) | **POST** /api/2.0/files/rooms | Create a room
*FilesRoomsApi* | [**CreateRoomFromTemplate**](docs/FilesRoomsApi.md#createroomfromtemplate) | **POST** /api/2.0/files/rooms/fromtemplate | Start create a room based on a template
...
*FilesRoomsApi* | [**CreateTemplate**](docs/FilesRoomsApi.md#createtemplate) | **POST** /api/2.0/files/roomtemplate | Start create room template
...
*FilesRoomsApi* | [**DeleteTags**](docs/FilesRoomsApi.md#deletetags) | **DELETE** /api/2.0/files/rooms/{id}/tags | Remove room tags
*FilesRoomsApi* | [**GetCovers**](docs/FilesRoomsApi.md#getcovers) | **GET** /api/2.0/files/rooms/covers | Gets covers
*FilesRoomsApi* | [**GetNewRoomItems**](docs/FilesRoomsApi.md#getnewroomitems) | **GET** /api/2.0/files/rooms/{id}/news | Get new room items
*FilesRoomsApi* | [**GetRoomCreatingStatus**](docs/FilesRoomsApi.md#getroomcreatingstatus) | **GET** /api/2.0/files/rooms/fromtemplate/status | Get progress creating room
*FilesRoomsApi* | [**GetRoomIndexExport**](docs/FilesRoomsApi.md#getroomindexexport) | **GET** /api/2.0/files/rooms/indexexport | Gets room index export
*FilesRoomsApi* | [**GetRoomInfo**](docs/FilesRoomsApi.md#getroominfo) | **GET** /api/2.0/files/rooms/{id} | Get room information
*FilesRoomsApi* | [**GetRoomLinks**](docs/FilesRoomsApi.md#getroomlinks) | **GET** /api/2.0/files/rooms/{id}/links | Get room links
*FilesRoomsApi* | [**GetRoomSecurityInfo**](docs/FilesRoomsApi.md#getroomsecurityinfo) | **GET** /api/2.0/files/rooms/{id}/share | Get room access rights
*FilesRoomsApi* | [**GetRoomsFolder**](docs/FilesRoomsApi.md#getroomsfolder) | **GET** /api/2.0/files/rooms | Get rooms
*FilesRoomsApi* | [**GetRoomsNewItems**](docs/FilesRoomsApi.md#getroomsnewitems) | **GET** /api/2.0/files/rooms/news | Gets room new items
*FilesRoomsApi* | [**GetRoomsPrimaryExternalLink**](docs/FilesRoomsApi.md#getroomsprimaryexternallink) | **GET** /api/2.0/files/rooms/{id}/link | Get primary external link
*FilesRoomsApi* | [**GetTagsInfo**](docs/FilesRoomsApi.md#gettagsinfo) | **GET** /api/2.0/files/tags | Get tags
*FilesRoomsApi* | [**GetTemplateCreatingStatus**](docs/FilesRoomsApi.md#gettemplatecreatingstatus) | **GET** /api/2.0/files/roomtemplate/status | Get progress creating room template
*FilesRoomsApi* | [**IsPublic**](docs/FilesRoomsApi.md#ispublic) | **GET** /api/2.0/files/roomtemplate/{id}/public | Get public
*FilesRoomsApi* | [**PinRoom**](docs/FilesRoomsApi.md#pinroom) | **PUT** /api/2.0/files/rooms/{id}/pin | Pin a room
*FilesRoomsApi* | [**Reorder**](docs/FilesRoomsApi.md#reorder) | **PUT** /api/2.0/files/rooms/{id}/reorder | Reorders to a room with ID specified in the request
*FilesRoomsApi* | [**ResendEmailInvitations**](docs/FilesRoomsApi.md#resendemailinvitations) | **POST** /api/2.0/files/rooms/{id}/resend | Resend room invitations
*FilesRoomsApi* | [**SetLink**](docs/FilesRoomsApi.md#setlink) | **PUT** /api/2.0/files/rooms/{id}/links | Set an external or invitation link
*FilesRoomsApi* | [**SetPublic**](docs/FilesRoomsApi.md#setpublic) | **PUT** /api/2.0/files/roomtemplate/public | Set public
*FilesRoomsApi* | [**SetRoomSecurity**](docs/FilesRoomsApi.md#setroomsecurity) | **PUT** /api/2.0/files/rooms/{id}/share | Set room access rights
*FilesRoomsApi* | [**StartRoomIndexExport**](docs/FilesRoomsApi.md#startroomindexexport) | **POST** /api/2.0/files/rooms/{id}/indexexport | Starts room index export
*FilesRoomsApi* | [**TerminateRoomIndexExport**](docs/FilesRoomsApi.md#terminateroomindexexport) | **DELETE** /api/2.0/files/rooms/indexexport | Terminates room index export
...
*FilesRoomsApi* | [**UpdateRoom**](docs/FilesRoomsApi.md#updateroom) | **PUT** /api/2.0/files/rooms/{id} | Rename a room
*FilesRoomsApi* | [**UploadRoomLogo**](docs/FilesRoomsApi.md#uploadroomlogo) | **POST** /api/2.0/files/logos | Upload an image for room logo
...
*FilesSettingsApi* | [**Forcesave**](docs/FilesSettingsApi.md#forcesave) | **PUT** /api/2.0/files/forcesave | Change the forcasaving ability
...
*FilesSettingsApi* | [**HideConfirmCancelOperation**](docs/FilesSettingsApi.md#hideconfirmcanceloperation) | **PUT** /api/2.0/files/hideconfirmcanceloperation | Hide confirmation dialog when canceling operation
...
*FilesSettingsApi* | [**SetOpenEditorInSameTab**](docs/FilesSettingsApi.md#setopeneditorinsametab) | **PUT** /api/2.0/files/settings/openeditorinsametab | Open document in same browser tab
...
*FilesThirdPartyIntegrationApi* | [**GetCommonThirdPartyFolders**](docs/FilesThirdPartyIntegrationApi.md#getcommonthirdpartyfolders) | **GET** /api/2.0/files/thirdparty/common | Get common third-party services
*FilesThirdPartyIntegrationApi* | [**GetThirdPartyAccounts**](docs/FilesThirdPartyIntegrationApi.md#getthirdpartyaccounts) | **GET** /api/2.0/files/thirdparty | Get third-party accounts
...
*GroupRoomsApi* | [**GetGroupsWithShared**](docs/GroupRoomsApi.md#getgroupswithshared) | **GET** /api/2.0/group/room/{id} | Gets groups with shared
*MigrationApi* | [**Cancel**](docs/MigrationApi.md#cancel) | **POST** /api/2.0/migration/cancel | Cancels migration
*MigrationApi* | [**Clear**](docs/MigrationApi.md#clear) | **POST** /api/2.0/migration/clear | Clears migration
*MigrationApi* | [**Finish**](docs/MigrationApi.md#finish) | **POST** /api/2.0/migration/finish | Finishes migration
*MigrationApi* | [**List**](docs/MigrationApi.md#list) | **GET** /api/2.0/migration/list | Gets migration list
*MigrationApi* | [**Logs**](docs/MigrationApi.md#logs) | **GET** /api/2.0/migration/logs | Gets migration logs
*MigrationApi* | [**Migrate**](docs/MigrationApi.md#migrate) | **POST** /api/2.0/migration/migrate | Migrates
*MigrationApi* | [**Status**](docs/MigrationApi.md#status) | **GET** /api/2.0/migration/status | Gets migration status
*MigrationApi* | [**UploadAndInit**](docs/MigrationApi.md#uploadandinit) | **POST** /api/2.0/migration/init/{migratorName} | Uploads and inits migration
*ModulesApi* | [**GetAllPortalModules**](docs/ModulesApi.md#getallportalmodules) | **GET** /api/2.0/modules | Get modules
*ModulesApi* | [**GetAllWithInfo**](docs/ModulesApi.md#getallwithinfo) | **GET** /api/2.0/modules/info | Get modules information
...
*PeopleGuestsApi* | [**DeleteGuests**](docs/PeopleGuestsApi.md#deleteguests) | **DELETE** /api/2.0/people/guests | Removes guests from the list and from rooms
...
*PeopleProfilesApi* | [**GetClaims**](docs/PeopleProfilesApi.md#getclaims) | **GET** /api/2.0/people/tokendiagnostics | Gets claims
...
*PeopleProfilesApi* | [**UpdateMemberCulture**](docs/PeopleProfilesApi.md#updatememberculture) | **PUT** /api/2.0/people/{userid}/culture | Update user language
...
*PeopleSearchApi* | [**GetAccountsEntriesWithShared**](docs/PeopleSearchApi.md#getaccountsentrieswithshared) | **GET** /api/2.0/accounts/room/{id}/search | Gets accounts entries with shared
...
*PeopleSearchApi* | [**GetFullByFilter**](docs/PeopleSearchApi.md#getfullbyfilter) | **GET** /api/2.0/people/filter | Search users and their information by extended filter
...
*PeopleSearchApi* | [**GetUsersWithRoomShared**](docs/PeopleSearchApi.md#getuserswithroomshared) | **GET** /api/2.0/people/room/{id} | Gets users with shared in room ID specified in request
*PeopleThemeApi* | [**ChangeTheme**](docs/PeopleThemeApi.md#changetheme) | **PUT** /api/2.0/people/theme | Change portal theme
*PeopleThemeApi* | [**GetTheme**](docs/PeopleThemeApi.md#gettheme) | **GET** /api/2.0/people/theme | Get portal theme
...
*PortalQuotaApi* | [**GetUsedSpace**](docs/PortalQuotaApi.md#getusedspace) | **GET** /api/2.0/portal/usedspace | Get the used portal space
...
*SecurityActiveConnectionsApi* | [**LogOutAllExceptThisConnection**](docs/SecurityActiveConnectionsApi.md#logoutallexceptthisconnection) | **PUT** /api/2.0/security/activeconnections/logoutallexceptthis | Log out from all connections
...
*SecurityCSPApi* | [**Csp**](docs/SecurityCSPApi.md#csp) | **POST** /api/2.0/security/csp | Csp
*SecurityCSPApi* | [**GetCsp**](docs/SecurityCSPApi.md#getcsp) | **GET** /api/2.0/security/csp | Gets csp
...
*SecuritySMTPSettingsApi* | [**GetSmtpOperationStatus**](docs/SecuritySMTPSettingsApi.md#getsmtpoperationstatus) | **GET** /api/2.0/smtpsettings/smtp/test/status | Get the SMTP test process status
...
*SettingsCommonSettingsApi* | [**CloseAdminHelper**](docs/SettingsCommonSettingsApi.md#closeadminhelper) | **PUT** /api/2.0/settings/closeadminhelper | Close the admin helper notification
...
*SettingsCommonSettingsApi* | [**GettDeepLinkSettings**](docs/SettingsCommonSettingsApi.md#gettdeeplinksettings) | **GET** /api/2.0/settings/deeplink | Gets deeplink settings
...
*SettingsCommonSettingsApi* | [**SaveConfigureDeepLink**](docs/SettingsCommonSettingsApi.md#saveconfiguredeeplink) | **POST** /api/2.0/settings/deeplink | Configure deep link settings
...
*SettingsIPRestrictionsApi* | [**SaveIpRestrictions**](docs/SettingsIPRestrictionsApi.md#saveiprestrictions) | **PUT** /api/2.0/settings/iprestrictions | Save the IP restriction settings
*SettingsIPRestrictionsApi* | [**UpdateIpRestrictionsSettings**](docs/SettingsIPRestrictionsApi.md#updateiprestrictionssettings) | **PUT** /api/2.0/settings/iprestrictions/settings | Save the IP restriction settings
...
*SettingsLoginSettingsApi* | [**GetLoginSettings**](docs/SettingsLoginSettingsApi.md#getloginsettings) | **GET** /api/2.0/settings/security/loginsettings | Get login settings
*SettingsLoginSettingsApi* | [**SetDefaultLoginSettings**](docs/SettingsLoginSettingsApi.md#setdefaultloginsettings) | **DELETE** /api/2.0/settings/security/loginsettings | Returns the portal login settings.
*SettingsLoginSettingsApi* | [**UpdateLoginSettings**](docs/SettingsLoginSettingsApi.md#updateloginsettings) | **PUT** /api/2.0/settings/security/loginsettings | Update login settings
...
*SettingsQuotaApi* | [**GetUserQuotaSettings**](docs/SettingsQuotaApi.md#getuserquotasettings) | **GET** /api/2.0/settings/userquotasettings | Gets user quota
...
*SettingsSecurityApi* | [**SetAccessToWebItems**](docs/SettingsSecurityApi.md#setaccesstowebitems) | **PUT** /api/2.0/settings/security/access | Set the access settings to products
...
*SettingsTeamTemplatesApi* | [**PeopleSchema**](docs/SettingsTeamTemplatesApi.md#peopleschema) | **GET** /api/2.0/settings/customschemas/{id} | Get a team template by ID
*SettingsTeamTemplatesApi* | [**PeopleSchemas**](docs/SettingsTeamTemplatesApi.md#peopleschemas) | **GET** /api/2.0/settings/customschemas | Get team templates
*SettingsTeamTemplatesApi* | [**SaveCustomNamingSettings**](docs/SettingsTeamTemplatesApi.md#savecustomnamingsettings) | **PUT** /api/2.0/settings/customschemas | Create a custom team template
*SettingsTeamTemplatesApi* | [**SaveNamingSettings**](docs/SettingsTeamTemplatesApi.md#savenamingsettings) | **POST** /api/2.0/settings/customschemas | Save the naming settings
*SettingsTipsApi* | [**GetTipsSubscription**](docs/SettingsTipsApi.md#gettipssubscription) | **GET** /api/2.0/settings/tips/subscription | Check the tip subscription
*SettingsTipsApi* | [**UpdateTipsSettings**](docs/SettingsTipsApi.md#updatetipssettings) | **PUT** /api/2.0/settings/tips | Update the tip settings
*SettingsTipsApi* | [**UpdateTipsSubscription**](docs/SettingsTipsApi.md#updatetipssubscription) | **PUT** /api/2.0/settings/tips/change/subscription | Update the tip subscription
...
*SettingsWebhooksApi* | [**DisableWebHook**](docs/SettingsWebhooksApi.md#disablewebhook) | **PUT** /api/2.0/settings/webhook/{id} | Disable a webhook
...
*SettingsWebhooksApi* | [**Settings**](docs/SettingsWebhooksApi.md#settings) | **GET** /api/2.0/settings/webhooks | Get webhook settings
...
*SettingsWebpluginsApi* | [**AddWebPluginFromFile**](docs/SettingsWebpluginsApi.md#addwebpluginfromfile) | **POST** /api/2.0/settings/webplugins | Adds web plugins from file
*SettingsWebpluginsApi* | [**DeleteWebPlugin**](docs/SettingsWebpluginsApi.md#deletewebplugin) | **DELETE** /api/2.0/settings/webplugins/{name} | Deletes web plugins by name specified in request
*SettingsWebpluginsApi* | [**GetWebPlugin**](docs/SettingsWebpluginsApi.md#getwebplugin) | **GET** /api/2.0/settings/webplugins/{name} | Gets web plugins by name specified in request
*SettingsWebpluginsApi* | [**GetWebPlugins**](docs/SettingsWebpluginsApi.md#getwebplugins) | **GET** /api/2.0/settings/webplugins | Gets web plugins
*SettingsWebpluginsApi* | [**UpdateWebPlugin**](docs/SettingsWebpluginsApi.md#updatewebplugin) | **PUT** /api/2.0/settings/webplugins/{name} | Updates web plugins
...
## Documentation for Models
 ...
 - [Model.ModuleArrayWrapper](docs/ModuleArrayWrapper.md)
 ...
 - [Model.SchemaBaseRequestsDto](docs/SchemaBaseRequestsDto.md)
 - [Model.SchemaRequestsArrayWrapper](docs/SchemaRequestsArrayWrapper.md)
 - [Model.SchemaRequestsDto](docs/SchemaRequestsDto.md)
 - [Model.SchemaRequestsWrapper](docs/SchemaRequestsWrapper.md)
 ...
 - [Model.TipsRequestDto](docs/TipsRequestDto.md)
 - [Model.TipsSettings](docs/TipsSettings.md)
 - [Model.TipsSettingsWrapper](docs/TipsSettingsWrapper.md)
 ...
 - [Model.WebhookArrayWrapper](docs/WebhookArrayWrapper.md)
 - [Model.WebhookGroupStatus](docs/WebhookGroupStatus.md)
 - [Model.WebhookRetryRequestsDto](docs/WebhookRetryRequestsDto.md)
 - [Model.WebhookWrapper](docs/WebhookWrapper.md)
 - [Model.WebhooksConfigDto](docs/WebhooksConfigDto.md)
 - [Model.WebhooksConfigRequestsDto](docs/WebhooksConfigRequestsDto.md)
