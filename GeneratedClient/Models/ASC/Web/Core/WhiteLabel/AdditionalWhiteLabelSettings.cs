...
namespace KiotaPosts.Client.Models.ASC.Web.Core.WhiteLabel
{
    ...
    public partial class AdditionalWhiteLabelSettings : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::KiotaPosts.Client.Models.ASC.Web.Core.WhiteLabel.AdditionalWhiteLabelSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::KiotaPosts.Client.Models.ASC.Web.Core.WhiteLabel.AdditionalWhiteLabelSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::KiotaPosts.Client.Models.ASC.Web.Core.WhiteLabel.AdditionalWhiteLabelSettings();
        }
        /// <summary>
