...
namespace KiotaPosts.Client.Models.ASC.Web.Api.ApiModel.ResponseDto
{
    ...
    public partial class AuditEventDto : IParsable
...
#nullable restore
        ...
        public string Ip { get; set; }
#endif
        /// <summary>[0 - None, 1 - Files, 2 - Folders, 3 - Documents settings, 4 - Companies, 5 - Persons, 6 - Contacts, 7 - Crm tasks, 8 - Opportunities, 9 - Invoices, 10 - Cases, 11 - Common crm settings, 12 - Contacts settings, 13 - Contact types, 14 - Invoice settings, 15 - Other crm settings, 16 - Users, 17 - Groups, 18 - Projects, 19 - Milestones, 20 - Tasks, 21 - Discussions, 22 - Time tracking, 23 - Reports, 24 - Projects settings, 25 - General, 26 - Products, 27 - Rooms, 28 - OAuth]</summary>
...
#nullable restore
        ...
        public string Platform { get; set; }
#endif
        /// <summary>[0 - None, 2 - Documents, 3 - Login, 4 - Others, 5 - People, 7 - Settings]</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::KiotaPosts.Client.Models.ASC.Web.Api.ApiModel.ResponseDto.AuditEventDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::KiotaPosts.Client.Models.ASC.Web.Api.ApiModel.ResponseDto.AuditEventDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::KiotaPosts.Client.Models.ASC.Web.Api.ApiModel.ResponseDto.AuditEventDto();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "entries", n => { Entries = n.GetCollectionOfPrimitiveValues<int?>()?.AsList(); } },
                { "id", n => { Id = n.GetIntValue(); } },
                { "ip", n => { Ip = n.GetStringValue(); } },
                { "module", n => { Module = n.GetIntValue(); } },
                { "page", n => { Page = n.GetStringValue(); } },
                { "platform", n => { Platform = n.GetStringValue(); } },
                { "product", n => { Product = n.GetIntValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfPrimitiveValues<int?>("entries", Entries);
            writer.WriteIntValue("id", Id);
            writer.WriteStringValue("ip", Ip);
            writer.WriteIntValue("module", Module);
            writer.WriteStringValue("page", Page);
            writer.WriteStringValue("platform", Platform);
            writer.WriteIntValue("product", Product);
