...
|------|------|-------------|-------|
| **roomGroupRequestDto** | [**RoomGroupRequestDto?**](RoomGroupRequestDto.md) | The request parameters for creating a room group | [optional]  |
...
namespace Example
{
    public class AddRoomGroupExample
    {
        public static void Main()
        {
            ...
            var roomGroupRequestDto = new RoomGroupRequestDto?(); // RoomGroupRequestDto? | The request parameters for creating a room group (optional) 
            ...
            {
                Debug.Print("Exception when calling FilesApi.AddRoomGroup: " + e.Message);
...
{
    Debug.Print("Exception when calling FilesApi.AddRoomGroupWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ChangeRoomGroupIconExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new FilesApi(httpClient, config, httpClientHandler);
            var id = 1;  // int | Group id
            var iconRequest = new IconRequest?(); // IconRequest? | Icon update data. (optional) 
            ...
            {
                Debug.Print("Exception when calling FilesApi.ChangeRoomGroupIcon: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling FilesApi.ChangeRoomGroupIconWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class DeleteRoomGroupExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FilesApi.DeleteRoomGroup: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling FilesApi.DeleteRoomGroupWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetRoomGroupInfoExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FilesApi.GetRoomGroupInfo: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling FilesApi.GetRoomGroupInfoWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **GetRoomGroups**
> RoomGroupArrayWrapper GetRoomGroups (int id, bool? includeMembers = null)
...
namespace Example
{
    public class GetRoomGroupsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FilesApi.GetRoomGroups: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    // List room groups
    ApiResponse<RoomGroupArrayWrapper> response = apiInstance.GetRoomGroupsWithHttpInfo(id, includeMembers);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling FilesApi.GetRoomGroupsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class UpdateRoomGroupExample
    {
        public static void Main()
        {
            ...
            var updateRoomGroupRequest = new UpdateRoomGroupRequest(); // UpdateRoomGroupRequest | The request for updating a group.
            ...
            {
                Debug.Print("Exception when calling FilesApi.UpdateRoomGroup: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling FilesApi.UpdateRoomGroupWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
