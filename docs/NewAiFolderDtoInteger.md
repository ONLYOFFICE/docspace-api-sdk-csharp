# DocSpace.API.SDK.Model.NewAiFolderDtoInteger
...
**Logo** | [**NewAiLogo**](NewAiLogo.md) |  | [optional] 
**Pinned** | **bool** | Specifies if the folder is pinned or not. | [optional] 
**RoomType** | **NewAiRoomType** |  | [optional] 
...
**Lifetime** | [**NewAiRoomDataLifetimeDto**](NewAiRoomDataLifetimeDto.md) |  | [optional] 
**Watermark** | [**NewAiWatermarkDto**](NewAiWatermarkDto.md) |  | [optional] 
**Type** | **NewAiFolderType** |  | [optional] 
...
**ChatSettings** | [**NewAiChatSettingsDto**](NewAiChatSettingsDto.md) |  | [optional] 
**RootRoomType** | **NewAiRoomType** |  | [optional] 
