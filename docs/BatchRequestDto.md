...
**FolderIds** | **List&lt;int&gt;** | The list of folder IDs to be copied/moved. | [optional] 
**FileIds** | **List&lt;int&gt;** | The list of file IDs to be copied/moved. | [optional] 
**DestFolderId** | **int** |  | [optional] 
