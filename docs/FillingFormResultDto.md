# DocSpace.API.SDK.Model.FillingFormResultDto
...
**CompletedForm** | [**FileDto**](FileDto.md) | The filled copy that the session produced, as an ordinary file: it can be read and downloaded with the file  operations of this API. | [optional] 
**OriginalForm** | [**FileDto**](FileDto.md) | The form the copy was made from, so that a client can offer filling it once more. | [optional] 
