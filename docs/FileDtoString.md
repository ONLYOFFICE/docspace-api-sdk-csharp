# DocSpace.API.SDK.Model.FileDtoString
The file parameters.
...
**FolderId** | **string** | The folder ID where the file is located. | [optional] 
...
**DraftLocation** | [**DraftLocationString**](DraftLocationString.md) |  | [optional] 
