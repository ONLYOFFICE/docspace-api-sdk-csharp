...
| **version** | **string?** | The optional version of the encryption key to filter by. | [optional]  |
...
namespace Example
{
    public class GetUserKeysByFilterExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new PrivacyroomApi(httpClient, config, httpClientHandler);
            var id = 00000000-0000-0000-0000-000000000000;  // Guid? | The optional identifier of the encryption key to filter by. (optional) 
            var type = new EncryptionKeyType?(); // EncryptionKeyType? | The optional type of the encryption key to filter by. (optional) 
            var version = 1;  // string? | The optional version of the encryption key to filter by. (optional) 
            var publicKey = some public key;  // string? | The optional public key to filter by. (optional) 
            var privateKeyEnc = some encrypted private key;  // string? | The optional encrypted private key to filter by. (optional) 
