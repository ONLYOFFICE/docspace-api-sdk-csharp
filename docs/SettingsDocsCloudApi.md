...
|------|------|-------------|-------|
| **docsCloudDevPackRequestDto** | [**DocsCloudDevPackRequestDto?**](DocsCloudDevPackRequestDto.md) | The request parameters for switch the DocsCloud subscription to DocsCloudDevPack. | [optional]  |
...
namespace Example
{
    public class CalculateDevPackExample
    {
        public static void Main()
        {
            ...
            var docsCloudDevPackRequestDto = new DocsCloudDevPackRequestDto?(); // DocsCloudDevPackRequestDto? | The request parameters for switch the DocsCloud subscription to DocsCloudDevPack. (optional) 
...
namespace Example
{
    public class GetTenantExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new DocsCloudApi(httpClient, config, httpClientHandler);
            var refresh = false;  // bool? | Specifies whether to bypass the cache and request the tenant from DocsCloud again. (optional)  (default to false)
...
namespace Example
{
    public class GetTenantConfigExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new DocsCloudApi(httpClient, config, httpClientHandler);
            var refresh = false;  // bool? | Specifies whether to bypass the cache and request the tenant configuration from DocsCloud again. (optional)  (default to false)
...
namespace Example
{
    public class GetTenantInfoExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new DocsCloudApi(httpClient, config, httpClientHandler);
            var refresh = false;  // bool? | Specifies whether to bypass the cache and request the tenant information from DocsCloud again. (optional)  (default to false)
...
namespace Example
{
    public class GetTenantQuotaExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new DocsCloudApi(httpClient, config, httpClientHandler);
            var refresh = false;  // bool? | Specifies whether to bypass the cache and request the user quota from DocsCloud again. (optional)  (default to false)
...
namespace Example
{
    public class GetTenantUsageExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new DocsCloudApi(httpClient, config, httpClientHandler);
            var refresh = false;  // bool? | Specifies whether to bypass the cache and request the usage statistics from DocsCloud again. (optional)  (default to false)
