...
| [**AddRoomTags**](#addroomtags-thirdparty) | **PUT** /api/2.0/files/rooms/{id}/tags | Attach tags to a room (third-party storage) |
| [**ArchiveRoom**](#archiveroom) | **PUT** /api/2.0/files/rooms/{id}/archive | Archive a room |
| [**ArchiveRoom**](#archiveroom-thirdparty) | **PUT** /api/2.0/files/rooms/{id}/archive | Archive a room (third-party storage) |
| [**ChangeRoomCover**](#changeroomcover) | **POST** /api/2.0/files/rooms/{id}/cover | Change the room cover |
| [**ChangeRoomCover**](#changeroomcover-thirdparty) | **POST** /api/2.0/files/rooms/{id}/cover | Change the room cover (third-party storage) |
...
| [**CreateRoomLogo**](#createroomlogo-thirdparty) | **POST** /api/2.0/files/rooms/{id}/logo | Set the room logo (third-party storage) |
...
| [**DeleteRoom**](#deleteroom-thirdparty) | **DELETE** /api/2.0/files/rooms/{id} | Remove a room (third-party storage) |
| [**DeleteRoomLogo**](#deleteroomlogo) | **DELETE** /api/2.0/files/rooms/{id}/logo | Remove a room logo |
| [**DeleteRoomLogo**](#deleteroomlogo-thirdparty) | **DELETE** /api/2.0/files/rooms/{id}/logo | Remove a room logo (third-party storage) |
| [**DeleteRoomTags**](#deleteroomtags) | **DELETE** /api/2.0/files/rooms/{id}/tags | Detach tags from a room |
| [**DeleteRoomTags**](#deleteroomtags-thirdparty) | **DELETE** /api/2.0/files/rooms/{id}/tags | Detach tags from a room (third-party storage) |
...
| [**GetRoomInfo**](#getroominfo-thirdparty) | **GET** /api/2.0/files/rooms/{id} | Get room information (third-party storage) |
| [**GetRoomLinks**](#getroomlinks) | **GET** /api/2.0/files/rooms/{id}/links | Get the room links |
| [**GetRoomLinks**](#getroomlinks-thirdparty) | **GET** /api/2.0/files/rooms/{id}/links | Get the room links (third-party storage) |
| [**GetRoomSecurityInfo**](#getroomsecurityinfo) | **GET** /api/2.0/files/rooms/{id}/share | Get the room access rights |
| [**GetRoomSecurityInfo**](#getroomsecurityinfo-thirdparty) | **GET** /api/2.0/files/rooms/{id}/share | Get the room access rights (third-party storage) |
...
| [**GetRoomsPrimaryExternalLink**](#getroomsprimaryexternallink-thirdparty) | **GET** /api/2.0/files/rooms/{id}/link | Get the room primary external link (third-party storage) |
...
| [**PinRoom**](#pinroom-thirdparty) | **PUT** /api/2.0/files/rooms/{id}/pin | Pin a room (third-party storage) |
...
| [**SetRoomSecurity**](#setroomsecurity-thirdparty) | **PUT** /api/2.0/files/rooms/{id}/share | Set the room access rights (third-party storage) |
...
| [**UnarchiveRoom**](#unarchiveroom-thirdparty) | **PUT** /api/2.0/files/rooms/{id}/unarchive | Unarchive a room (third-party storage) |
| [**UnpinRoom**](#unpinroom) | **PUT** /api/2.0/files/rooms/{id}/unpin | Unpin a room |
| [**UnpinRoom**](#unpinroom-thirdparty) | **PUT** /api/2.0/files/rooms/{id}/unpin | Unpin a room (third-party storage) |
| [**UpdateRoom**](#updateroom) | **PUT** /api/2.0/files/rooms/{id} | Update a room |
| [**UpdateRoom**](#updateroom-thirdparty) | **PUT** /api/2.0/files/rooms/{id} | Update a room (third-party storage) |
...
<a id="addroomtags"></a>
# **AddRoomTags**
> FolderWrapper AddRoomTags (int id, BatchTagsRequestDto? batchTagsRequestDto = null)
    ...
    public class AddRoomTagsExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                FolderWrapper result = apiInstance.AddRoomTags(id, batchTagsRequestDto);
...
{
    // Attach tags to a room
    ApiResponse<FolderWrapper> response = apiInstance.AddRoomTagsWithHttpInfo(id, batchTagsRequestDto);
...
<a id="addroomtags-thirdparty"></a>
# **AddRoomTags** (third-party storage)
> ThirdPartyFolderWrapper AddRoomTags (string id, BatchTagsRequestDto? batchTagsRequestDto = null)
...
namespace Example
{
    public class AddRoomTagsExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room whose tags are changed, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var batchTagsRequestDto = new BatchTagsRequestDto?(); // BatchTagsRequestDto? | The names to attach or to detach. (optional) 

            try
            {
                // Attach tags to a room (third-party storage)
                ThirdPartyFolderWrapper result = apiInstance.AddRoomTags(id, batchTagsRequestDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Attach tags to a room (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.AddRoomTagsWithHttpInfo(id, batchTagsRequestDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="archiveroom-thirdparty"></a>
# **ArchiveRoom** (third-party storage)
> FileOperationWrapper ArchiveRoom (string id, ArchiveRoomRequest? archiveRoomRequest = null)
...
namespace Example
{
    public class ArchiveRoomExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room to move, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var archiveRoomRequest = new ArchiveRoomRequest?(); // ArchiveRoomRequest? | The body of the request. It carries only the lifetime of the job record, so an empty object is a normal  request. (optional) 
    ...
    public class ChangeRoomCoverExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                FolderWrapper result = apiInstance.ChangeRoomCover(id, coverRequestDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Change the room cover
    ApiResponse<FolderWrapper> response = apiInstance.ChangeRoomCoverWithHttpInfo(id, coverRequestDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="changeroomcover-thirdparty"></a>
...
namespace Example
{
    public class ChangeRoomCoverExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room to change, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var coverRequestDto = new CoverRequestDto(); // CoverRequestDto | The cover and the colour to apply. Either half may be sent on its own, and an empty object leaves the room as  it is.

            try
            {
                // Change the room cover (third-party storage)
                ThirdPartyFolderWrapper result = apiInstance.ChangeRoomCover(id, coverRequestDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Change the room cover (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.ChangeRoomCoverWithHttpInfo(id, coverRequestDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="createroom"></a>
# **CreateRoom**
> FolderWrapper CreateRoom (CreateRoomRequestDto? createRoomRequestDto = null)
...
namespace Example
{
    public class CreateRoomExample
    {
        public static void Main()
        {
            ...
            {
                // Create a room
                FolderWrapper result = apiInstance.CreateRoom(createRoomRequestDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Create a room
    ApiResponse<FolderWrapper> response = apiInstance.CreateRoomWithHttpInfo(createRoomRequestDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class CreateRoomLogoExample
    {
        public static void Main()
        {
            ...
            {
                // Set the room logo
                FolderWrapper result = apiInstance.CreateRoomLogo(id, logoRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Set the room logo
    ApiResponse<FolderWrapper> response = apiInstance.CreateRoomLogoWithHttpInfo(id, logoRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="createroomlogo-thirdparty"></a>
...
namespace Example
{
    public class CreateRoomLogoExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room the logo is set on.
            var logoRequest = new LogoRequest(); // LogoRequest | The uploaded picture and the piece of it to use.

            try
            {
                // Set the room logo (third-party storage)
                ThirdPartyFolderWrapper result = apiInstance.CreateRoomLogo(id, logoRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Set the room logo (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.CreateRoomLogoWithHttpInfo(id, logoRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class DeleteRoomExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 10;  // string | The room to delete, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var deleteRoomRequest = new DeleteRoomRequest(); // DeleteRoomRequest | The body of the request. It is required even though the deletion does not depend on what it holds.
...
namespace Example
{
    public class DeleteRoomLogoExample
    {
        public static void Main()
        {
            ...
            {
                // Remove a room logo
                FolderWrapper result = apiInstance.DeleteRoomLogo(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Remove a room logo
    ApiResponse<FolderWrapper> response = apiInstance.DeleteRoomLogoWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="deleteroomlogo-thirdparty"></a>
...
namespace Example
{
    public class DeleteRoomLogoExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room to act on, named by the identifier that `GET api/2.0/files/rooms` reports for it. Rooms kept in the  portal itself use whole numbers, while a room backed by a connected third-party account uses the string form  of the same listing.

            try
            {
                // Remove a room logo (third-party storage)
                ThirdPartyFolderWrapper result = apiInstance.DeleteRoomLogo(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Remove a room logo (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.DeleteRoomLogoWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **DeleteRoomTags**
> FolderWrapper DeleteRoomTags (int id, BatchTagsRequestDto? batchTagsRequestDto = null)
    ...
    public class DeleteRoomTagsExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                FolderWrapper result = apiInstance.DeleteRoomTags(id, batchTagsRequestDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Detach tags from a room
    ApiResponse<FolderWrapper> response = apiInstance.DeleteRoomTagsWithHttpInfo(id, batchTagsRequestDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="deleteroomtags-thirdparty"></a>
# **DeleteRoomTags** (third-party storage)
> ThirdPartyFolderWrapper DeleteRoomTags (string id, BatchTagsRequestDto? batchTagsRequestDto = null)
    ...
    public class DeleteRoomTagsExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                ThirdPartyFolderWrapper result = apiInstance.DeleteRoomTags(id, batchTagsRequestDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Detach tags from a room (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.DeleteRoomTagsWithHttpInfo(id, batchTagsRequestDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getnewroomitems-thirdparty"></a>
    ...
    public class GetRoomInfoExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                FolderWrapper result = apiInstance.GetRoomInfo(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Get room information
    ApiResponse<FolderWrapper> response = apiInstance.GetRoomInfoWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
    ...
    public class GetRoomInfoExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                ThirdPartyFolderWrapper result = apiInstance.GetRoomInfo(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Get room information (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.GetRoomInfoWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getroomlinks-thirdparty"></a>
# **GetRoomLinks** (third-party storage)
> FileShareArrayWrapper GetRoomLinks (string id, LinkType? type = null)
...
namespace Example
{
    public class GetRoomLinksExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room whose links are listed, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var type = new LinkType?(); // LinkType? | Narrows the answer to one kind of link: invitation links, which turn whoever opens them into a member, or  external links, which open the room without an account. Leaving it out returns both kinds together. (optional) 
...
<a id="getroomsecurityinfo-thirdparty"></a>
# **GetRoomSecurityInfo** (third-party storage)
> FileShareArrayWrapper GetRoomSecurityInfo (string id, ShareFilterType? filterType = null, int? count = null, int? startIndex = null, string? filterValue = null)
...
namespace Example
{
    public class GetRoomSecurityInfoExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room whose access list is read, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var filterType = new ShareFilterType?(); // ShareFilterType? | What kind of access entries to list. The default covers accounts and groups and leaves the sharing links of  the room out; those are read with `GET api/2.0/files/rooms/{id}/links`. (optional) 
            var count = 25;  // int? | How many entries to return in one answer. The total number of matching entries comes back in the response  headers, so it is what tells the caller whether another page is needed. (optional) 
            var startIndex = 0;  // int? | How many matching entries to skip before the page starts. Together with the page size it walks the list, which  is ordered by role and then by name and is therefore stable between calls. (optional) 
            var filterValue = Smith;  // string? | Keeps only the entries whose displayed name contains this text. An invitation that has not been accepted yet  is listed under the email address it was sent to, so that is what has to be searched for. (optional) 
...
<a id="getroomsprimaryexternallink-thirdparty"></a>
...
namespace Example
{
    public class PinRoomExample
    {
        public static void Main()
        {
            ...
            {
                // Pin a room
                FolderWrapper result = apiInstance.PinRoom(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Pin a room
    ApiResponse<FolderWrapper> response = apiInstance.PinRoomWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
    ...
    public class PinRoomExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                ThirdPartyFolderWrapper result = apiInstance.PinRoom(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Pin a room (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.PinRoomWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
    ...
    public class ReorderRoomExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                FolderWrapper result = apiInstance.ReorderRoom(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Reorder room contents
    ApiResponse<FolderWrapper> response = apiInstance.ReorderRoomWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
    ...
    public class ReorderRoomExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                ThirdPartyFolderWrapper result = apiInstance.ReorderRoom(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Reorder room contents (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.ReorderRoomWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="resendemailinvitations-thirdparty"></a>
...
namespace Example
{
    public class ResendEmailInvitationsExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room whose invitations are resent, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var userInvitation = new UserInvitation(); // UserInvitation | Which pending invitations to send again.
...
namespace Example
{
    public class SetRoomLinkExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room the link belongs to, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var roomLinkRequest = new RoomLinkRequest(); // RoomLinkRequest | The link to create, change or revoke.
...
<a id="setroomsecurity-thirdparty"></a>
...
namespace Example
{
    public class SetRoomSecurityExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room whose membership changes, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var roomInvitationRequest = new RoomInvitationRequest(); // RoomInvitationRequest | The membership changes to apply, together with how the people concerned are notified.
...
<a id="unarchiveroom-thirdparty"></a>
# **UnarchiveRoom** (third-party storage)
> FileOperationWrapper UnarchiveRoom (string id, ArchiveRoomRequest? archiveRoomRequest = null)
...
namespace Example
{
    public class UnpinRoomExample
    {
        public static void Main()
        {
            ...
            {
                // Unpin a room
                FolderWrapper result = apiInstance.UnpinRoom(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Unpin a room
    ApiResponse<FolderWrapper> response = apiInstance.UnpinRoomWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
    ...
    public class UnpinRoomExample
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                ThirdPartyFolderWrapper result = apiInstance.UnpinRoom(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Unpin a room (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.UnpinRoomWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class UpdateRoomExample
    {
        public static void Main()
        {
            ...
            {
                // Update a room
                FolderWrapper result = apiInstance.UpdateRoom(id, updateRoomRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Update a room
    ApiResponse<FolderWrapper> response = apiInstance.UpdateRoomWithHttpInfo(id, updateRoomRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class UpdateRoomExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new RoomsApi(httpClient, config, httpClientHandler);
            var id = 1;  // string | The room to update, named by the identifier that `GET api/2.0/files/rooms` reports for it.
            var updateRoomRequest = new UpdateRoomRequest(); // UpdateRoomRequest | The fields to change. Only the properties present in the object are applied, and a property that the object  does not define is rejected instead of being ignored.

            try
            {
                // Update a room (third-party storage)
                ThirdPartyFolderWrapper result = apiInstance.UpdateRoom(id, updateRoomRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Update a room (third-party storage)
    ApiResponse<ThirdPartyFolderWrapper> response = apiInstance.UpdateRoomWithHttpInfo(id, updateRoomRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
