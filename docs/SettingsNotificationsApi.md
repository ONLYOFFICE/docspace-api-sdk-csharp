...
namespace Example
{
    public class GetNotificationSettingsExample
    {
        public static void Main()
        {
            ...
            var type = (NotificationType) "0";  // NotificationType | Notification type (Badges, RoomsActivity, DailyFeed, UsefullTips)
...
|------|------|-------------|-------|
| **type** | **NotificationType** | Notification type (Badges, RoomsActivity, DailyFeed, UsefullTips) |  |
