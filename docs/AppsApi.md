...
namespace Example
{
    public class GetExample
    {
        public static void Main()
        {
            ...
            var id = ai-room;  // string | The application identifier.
...
namespace Example
{
    public class SetEnabledExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AppsApi(httpClient, config, httpClientHandler);
            var id = ai-room;  // string | The application identifier.
            var setAppEnabledBody = new SetAppEnabledBody(); // SetAppEnabledBody | New enabled state.
...
namespace Example
{
    public class SetSettingsExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AppsApi(httpClient, config, httpClientHandler);
            var id = ai-room;  // string | The application identifier.
            var setAppSettingsBody = new SetAppSettingsBody(); // SetAppSettingsBody | New settings document.
