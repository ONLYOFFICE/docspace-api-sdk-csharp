# DocSpace.API.SDK.Model.ThirdPartyCheckConversionRequestDto
...
------------ | ------------- | ------------- | -------------
**FileId** | **string** | The file to convert. It is taken from the route of the operation, so a value sent in the body is overwritten. | [optional] 
